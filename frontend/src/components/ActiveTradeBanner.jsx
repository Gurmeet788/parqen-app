...
function TradeCard({ trade, user, onClose }) {
  ...
  const minsLimit =
    rawLimit > 1440
      ? Math.min(480, Math.round(rawLimit / 60))
      : Math.min(480, Math.max(5, rawLimit));
  const computedMs =
    (toUTC(trade.created_at) || new Date()).getTime() + minsLimit * 60000;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundColor: isUrgent ? `${C.danger}12` : `${st.color}12`,
        }}
      >
        <span
        ...
        >
          <>
            {isBuyer ? <ShoppingCart size={14} /> : <Wallet size={14} />}
        ...
        <div className="flex items-center gap-2">
          {timeLeft && timeLeft !== "Expired" && (
            <span
              ...
              style={{
                backgroundColor: isUrgent ? C.danger : st.color,
                color: "#fff",
              }}
            >
      ...
      <div className="px-4 py-3 space-y-2 bg-white">
        ...
        <div className="flex justify-between text-xs">
          ...
          <div className="text-right">
            ...
            <div className="text-xs font-bold" style={{ color: C.g400 }}>
              ≈ {payDisp}
            </div>
          </div>
        </div>
