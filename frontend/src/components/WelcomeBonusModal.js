    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Complete 2 easy steps to unlock your free BTC — offer valid for 30
            days.
          </p>
        </div>
        ...
        <div style={{ padding: "20px 24px" }}>
          ...
          <div
            style={{
              width: 2,
              height: 16,
              background: step >= 2 ? C.mint : "#E2E8F0",
              marginLeft: 23,
              marginTop: -4,
              marginBottom: -4,
            }}
          ...
          <StepRow
            ...
            desc={
              step >= 2
                ? "$1 BTC is locked in your wallet."
                : "Verify to claim your first $1."
            }
            reward={
              step >= 2 ? "$1.00 BTC locked 🔒" : "$1.00 unlocks on verify"
            }
          ...
          <div
            style={{
              width: 2,
              height: 16,
              background: step >= 3 ? C.mint : "#E2E8F0",
              marginLeft: 23,
              marginTop: -4,
              marginBottom: -4,
            }}
          ...
          <StepRow
            ...
            desc={
              step >= 3
                ? "Both $2 BTC have been added to your wallet!"
                : "Trade once — both $2 instantly unlock."
            }
            reward={
              step >= 3
                ? "$2.00 BTC unlocked 🎉"
                : "$2.00 unlocks on first trade"
            }
        ...
        <div style={{ padding: "0 24px 24px" }}>
          ...
          {step === 2 && (
            <ActionButton
              color={C.green}
              onClick={onClose}
              label="Start Trading to Unlock $2 →"
            />
          )}
          {step === 3 && (
            <ActionButton
