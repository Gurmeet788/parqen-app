...
export default function Navbar({ user, onLogout }) {
  ...
  const [hdBalance, setHdBalance] = useState(() =>
    parseFloat(localStorage.getItem("praqen_btc_balance") || 0),
  );
  const [balanceUsd, setBalanceUsd] = useState(() =>
    parseFloat(localStorage.getItem("praqen_usd_balance") || 0),
  );
  const [lockedBtc, setLockedBtc] = useState(() =>
    parseFloat(localStorage.getItem("praqen_locked_btc") || 0),
  );
  const [usdtBalance, setUsdtBalance] = useState(() =>
    parseFloat(localStorage.getItem("praqen_usdt_balance") || 0),
  );
  ...
  const loadBalance = async () => {
    try {
      ...
      const [btcRes, usdtRes] = await Promise.all([
        ...
        axios
          .get(`${API_URL}/wallet/usdt`, { headers })
          .catch(() => ({ data: {} })),
      ]);

      const avail = parseFloat(
        btcRes.data?.available_btc ?? btcRes.data?.balance_btc ?? 0,
      );
      ...
      const totalBtcUsd =
        btcPrice > 0
          ? (avail + locked) * btcPrice
          : parseFloat(btcRes.data?.balance_usd || 0);
  ...
  const isMarketActive = ["/buy-bitcoin", "/sell-bitcoin"].some((p) =>
  ...
  const DesktopNavLinks = () => (
    <div className="hidden min-[1025px]:flex items-center gap-3 flex-1 justify-center">
      {/* Dashboard */}
      <Link
        to="/dashboard"
        style={{
      ...
      <div className="relative" ref={marketRef}>
        ...
        >
          ...
          <ChevronDown
            size={13}
            style={{
              transform: marketDrop ? "rotate(180deg)" : "none",
          ...
          >
            <Link
              ...
              style={{
                ...
                background: isActive("/buy-bitcoin") ? C.mist : "#fff",
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: 10, color: C.g400 }}>
            ...
            <Link
              ...
              style={{
                ...
                padding: "12px 16px",
                textDecoration: "none",
                background: isActive("/sell-bitcoin") ? C.mist : "#fff",
                transition: "background 0.15s",
              }}
            >
              <div
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-8">
          ...
          >
            <Link to="/" style={{ textDecoration: "none", flexShrink: 0 }}>
              ...
              >
                <span style={{ color: C.forest }}>PRA</span>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-10">
        ...
        >
          ...
          >
            ...
            <div
              className="flex min-[1025px]:hidden items-center"
              style={{
                background: C.mist,
            ...
            <div
              className="hidden min-[1025px]:flex items-center"
              style={{
                gap: 6,
                background: C.mist,
                border: `1px solid #c8e6d4`,
            ...
            >
              ...
              >
                ...
                >
                  {showBal
                    ? `${localCode} ${sym}${fmt(totalLocal, 2)}`
                    : "••••••"}
                </span>
              </Link>
            </div>
            ...
            <div style={{ position: "relative" }} ref={dropRef}>
              ...
              >
                ...
                <ChevronDown
                  ...
                  color={C.g400}
                  style={{
                    transform: profileDrop ? "rotate(180deg)" : "none",
                    transition: "transform 0.2s",
                  }}
                />
              </button>
              ...
              {profileDrop && (
                ...
                >
                  ...
                  >
                    <TrendingUp
                      size={14}
                      color={isMarketActive ? C.forest : C.green}
                    />
                    <span
                      style={{
                        fontSize: 13,
                        fontWeight: 800,
                        color: isMarketActive ? C.forest : C.g800,
                      }}
                    >
                      P2P Trade
                    </span>
                  ...
                  <div style={{ padding: "6px 0" }}>
                    {[
                      ...
                      >
                        <Icon
                          size={14}
                          color={isActive(to) ? C.forest : color}
                          style={{ flexShrink: 0 }}
                        />
                        <span
                          style={{
                            fontSize: 13,
                            fontWeight: 800,
                            color: isActive(to) ? C.forest : C.g800,
                          }}
                        >
                          {label}
                        </span>
