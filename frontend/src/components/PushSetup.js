    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Get instant alerts when someone opens a trade, sends payment, or
            releases Bitcoin.
          </p>
        </div>
        ...
        <div style={{ padding: "20px 20px 8px" }}>
          {[
            {
              icon: Zap,
              text: "New trade request — respond before it expires",
            },
            {
              icon: DollarSign,
              text: "Payment received — release Bitcoin on time",
            },
            {
              icon: CheckCircle,
              text: "Bitcoin released — confirm funds arrived",
            },
          ].map(({ icon: Icon, text }) => (
            <div
              key={text}
    ...
    <>
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 22 }}>
          ...
          >
            <Smartphone size={36} color={C.forest} />
          </div>
          <p
            style={{
              fontWeight: 900,
          ...
          >
            Install PRAQEN to your home screen so we can send you instant trade
            notifications.
          </p>
        </div>
        ...
        {[
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                <Icon size={15} color={C.forest} /> {title}
              </p>
              <p
                style={{
                  fontSize: 12,
