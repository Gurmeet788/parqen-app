...
const BADGES = {
  ...
  AMBASSADOR: {
    label: "AMBASSADOR",
    icon: "◈",
    bg: "linear-gradient(135deg,#0D9488,#2D6A4F)",
    text: "#FFFFFF",
    borderColor: "#0D9488",
    next: "LEGEND",
    nextLabel: "Legend",
...
const fmtPct = (n) =>
  `${Math.min(100, Math.max(0, parseFloat(n || 0))).toFixed(1)}%`;
...
const getStatusBadge = (status) => {
  ...
  return (
    map[status] || { text: status || "Active", color: C.g400, icon: Clock }
  );
};
  ...
  return (
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="font-black text-sm" style={{ color: C.forest }}>
          {title}
        </h2>
      </div>
      {action && (
...
function ProfileSummary({ user, profile, stats }) {
  ...
  const tradesProgress = thresh
    ? Math.min(1, (stats.totalTrades || 0) / thresh.trades)
    : 1;
  const referralProgress = thresh
    ? Math.min(1, (stats.totalReferrals || 0) / (thresh.referrals || 1))
    : 1;

  return (
    <div
      className="bg-white rounded-2xl shadow-sm border overflow-hidden mb-4"
      style={{ borderColor: C.g200 }}
    >
      {/* Banner */}
      <div
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex items-end justify-between -mt-10 mb-3">
          <div className="relative">
            <div
              className="w-20 h-20 rounded-2xl border-4 border-white shadow-lg overflow-hidden flex items-center justify-center font-black text-2xl"
        ...
        <div className="flex items-center gap-2 flex-wrap mb-1">
          <h2 className="font-black text-lg" style={{ color: C.forest }}>
            {profile?.username || user?.username}
          </h2>
          <span
            className="inline-flex items-center gap-0.5 text-xs font-black px-2 py-0.5 rounded-full border"
            style={{ background: badge.bg, borderColor: badge.borderColor }}
          >
            <span
              style={{ color: badge.icon === "♛" ? "#92400E" : badge.text }}
            >
              {badge.icon}
            </span>
        ...
        >
          <span
            ...
            style={{ color: online ? C.online : C.g400 }}
          >
            <span
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
          {[
            ...
            {
              label: "Positive",
              value: fmt(stats.positiveFeedback || 0),
              color: C.success,
              icon: ThumbsUp,
            },
            {
              label: "Negative",
              value: fmt(stats.negativeFeedback || 0),
              color: C.danger,
              icon: ThumbsDown,
            },
            ...
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs font-black" style={{ color: C.g700 }}>
                ...
                <span style={{ color: C.amber }}>
                  {badge.nextLabel} {BADGES[nextKey]?.icon}
                </span>
              </p>
            </div>
              ...
              {thresh.trades > 0 && (
                <div>
                  ...
                  >
                    <span>Trades</span>
                    <span>
                      {stats.totalTrades || 0} / {thresh.trades}
                    </span>
                  </div>
                  <div
              ...
              {thresh.referrals > 0 && (
                <div>
                  ...
                  >
                    <span>Referrals</span>
                    <span>
                      {stats.totalReferrals || 0} / {thresh.referrals}
                    </span>
                  </div>
                  <div
                    className="h-1.5 rounded-full"
        ...
        {!thresh && (
          ...
          >
            ...
            <p className="text-xs font-black" style={{ color: C.amber }}>
              You've reached the highest badge — LEGEND! 🎉
            </p>
          </div>
        )}
      </div>
...
function AffiliateSection({
  ...
  const SHARE_LINKS = [
    {
      ...
      url: `https://twitter.com/intent/tweet?text=${encodeURIComponent(
        `Trading Bitcoin the safe way on @praqenapp 🔒 Join me and trade with full escrow protection. Sign up here:`,
      )} ${referralLink}`,
    },
    {
      label: "Telegram",
      ...
      url: `https://t.me/share/url?url=${encodeURIComponent(
        ...
        "Join PRAQEN — secure P2P Bitcoin trading worldwide!",
      )}`,
    },
  ];
  ...
  const currentTier =
    [...TIERS].reverse().find((t) => totalTrades >= t.trades) || null;
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="relative p-5 md:p-6">
          <div className="flex items-start justify-between gap-4 mb-5">
            <div>
              <div
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-black mb-3"
                style={{
              ...
              <h2
                className="text-xl md:text-2xl font-black text-white leading-tight mb-1"
              ...
              <p className="text-white/65 text-xs leading-relaxed">
                ...
                <strong className="text-yellow-300">0.1–0.3% commission</strong>{" "}
                in Bitcoin — instantly, automatically.
              </p>
            </div>
            <div
            ...
            >
              <Rocket size={28} strokeWidth={2.2} style={{ color: "#fff" }} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mb-5">
            ...
            >
              <div className="flex justify-center mb-1">
                <Coins size={20} color="#FDE68A" strokeWidth={2.2} />
              </div>

              <p className="font-black text-sm text-white">
                ₿ {fmtBtc(totalEarnings)}
              </p>
            ...
            >
              <div className="flex justify-center mb-1">
                <Users size={20} color="#93C5FD" strokeWidth={2.2} />
              </div>
            ...
            >
              <div className="flex justify-center mb-1">
                <Zap size={20} color="#86EFAC" strokeWidth={2.2} />
              </div>
          ...
          {/* Referral link box */}
          <div>
            <p className="text-xs font-bold text-white/60 mb-1.5 uppercase tracking-wider">
              Your Referral Link
            </p>
            <div className="flex gap-2">
              <div
              ...
              >
                ...
                <p className="flex-1 text-xs font-mono text-white/80 truncate">
                  {referralLink}
                </p>
              </div>
              <button
                ...
                style={{
                  backgroundColor: copied ? "#10B981" : C.gold,
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2" style={{ color: C.forest }}>
            <Megaphone size={16} strokeWidth={2.2} />
            <p className="text-xs font-black">Share Your Link</p>
          </div>
          <p className="text-xs" style={{ color: C.g400 }}>
            Tap to share on any platform
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs" style={{ color: C.g600 }}>
            ...
            <strong style={{ color: C.amber }}>instantly</strong> in BTC when
            your referral completes a trade.
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2" style={{ color: C.forest }}>
            ...
            <p className="text-xs font-black">Commission Tiers</p>
          </div>
          {currentTier ? (
            <span
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: done || active ? tier.color : C.g200,
                  }}
                >
                  {done || active ? (
                ...
                <div className="flex-1">
                  <p
                    className="text-xs font-black"
                    style={{
                      color: active ? tier.color : done ? C.g700 : C.g400,
                    }}
                  >
                    {tier.label}
                    {active && (
                  ...
                  <p className="text-xs" style={{ color: C.g400 }}>
                    {tier.trades} referral trades
                  </p>
                </div>
                <span
                  className="font-black text-xs flex-shrink-0"
                  style={{
                    color: active ? tier.color : done ? tier.color : C.g400,
                  }}
                >
                  {tier.reward}
                </span>
        ...
        {nextTier && (
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundImage:
                    totalTrades > 0 && totalTrades < nextTier.trades
                  ...
                  animation:
                    totalTrades > 0 && totalTrades < nextTier.trades
                      ? "tier-stripe 1.2s linear infinite"
                      : "none",
                }}
              />
            </div>
            ...
            {totalTrades > 0 && (
              ...
              >
                {nextTier.trades - totalTrades} more referral trade
                {nextTier.trades - totalTrades !== 1 ? "s" : ""} to unlock{" "}
                {nextTier.label} ({nextTier.reward})
              </p>
            )}
          </div>
        )}
      ...
      {btcPrice > 0 && (
        ...
        >
          ...
          >
            ...
            <p className="text-xs font-black">Withdraw Earnings</p>
          </div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <div className="flex items-center justify-center gap-2">
              {totalUsd >= 10 ? (
                <>
                  ...
                  <span>Withdraw ₿ {fmtBtc(totalEarnings)} to Wallet</span>
                </>
              ) : (
                <>
                  <Clock3 size={18} strokeWidth={2.2} />
                  <span>
                    Need ${Math.max(0, 10 - totalUsd).toFixed(2)} more to
                    withdraw
                  </span>
                </>
              )}
      ...
      >
        ...
        {referralData?.referredUsers?.length > 0 ? (
            ...
            {referralData.referredUsers.map((ru, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs" style={{ color: C.g400 }}>
                    {ru.total_trades > 0
                      ? `${ru.total_trades} trade${ru.total_trades > 1 ? "s" : ""}`
                      : "Joined · no trades yet"}
                    {ru.joined_at &&
                      ` · ${new Date(ru.joined_at).toLocaleDateString("en-US", { day: "numeric", month: "short", year: "numeric" })}`}
                  </p>
                </div>
                <div className="text-right flex-shrink-0">
                  {ru.total_earned > 0 ? (
                    <>
                      ...
                      >
                        +₿ {fmtBtc(ru.total_earned)}
                      </p>
                      {btcPrice > 0 && (
                        <p className="text-xs" style={{ color: C.g400 }}>
                          ≈ ${(ru.total_earned * btcPrice).toFixed(2)}
                        </p>
                      )}
                    </>
                  ) : (
          ...
          <div className="p-5">
            ...
            >
              ...
              <p
                ...
                style={{ color: C.forest }}
              >
                {totalReferrals} people signed up with your link!
              </p>
              <p className="text-xs leading-relaxed" style={{ color: C.g400 }}>
                Their profiles will appear here once they place their first
                trade.
                <br />
          ...
          <div className="p-6 text-center">
            ...
            <p className="text-sm font-black mb-1" style={{ color: C.forest }}>
              No referrals yet
            </p>
            <p className="text-xs" style={{ color: C.g400 }}>
              Share your link below to start earning BTC!
            </p>
          </div>
        )}
      </div>
      ...
      <div
        ...
        style={{ borderColor: C.g200 }}
      >
        <p className="text-xs font-black mb-3" style={{ color: C.forest }}>
          ...
          {[
            {
              ...
              body: "Copy your unique referral link and share it on WhatsApp, Telegram, Twitter or anywhere.",
              color: "#3B82F6",
            },
            {
              step: "2",
              title: "Friend Signs Up & Trades",
              body: "When your friend clicks your link, registers, and completes a trade — you earn automatically.",
              color: C.green,
            },
            {
              step: "3",
              title: "Earn BTC Commission",
              body: "You receive 0.1%–0.3% of every trade value in Bitcoin, directly credited to your account.",
              color: C.amber,
            },
            {
              step: "4",
              title: "No Limits, No Expiry",
              body: "Earn forever — there's no cap on how many people you refer or how much BTC you can earn.",
              color: C.purple,
            },
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-black" style={{ color: C.forest }}>
                Top Earners — Affiliate Leaderboard
              </p>
            </div>
            <span
              className="text-xs font-bold px-2 py-0.5 rounded-full"
              style={{ backgroundColor: `${C.amber}20`, color: C.amber }}
            >
              All Time
            </span>
          </div>
          <div className="divide-y" style={{ borderColor: C.g50 }}>
            {leaderboard.slice(0, 10).map((entry) => (
              <div
                key={entry.rank}
                className={`flex items-center gap-3 px-4 py-3 transition ${entry.rank <= 3 ? "hover:bg-yellow-50" : "hover:bg-gray-50"}`}
              >
                {/* Rank */}
                ...
                {/* Avatar */}
                <div
                  className="w-9 h-9 rounded-full flex items-center justify-center font-black text-sm text-white flex-shrink-0 shadow-sm"
                  style={{
                    backgroundColor: BADGE_COLORS[entry.badge] || C.green,
                  }}
                >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    <span
                      ...
                      style={{
                        backgroundColor: `${BADGE_COLORS[entry.badge] || C.green}18`,
                        color: BADGE_COLORS[entry.badge] || C.green,
                      }}
                    >
                      {entry.badge}
                    </span>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: C.g400 }}>
                    ...
                    · {entry.affiliate_trades} ref trade
                    {entry.affiliate_trades !== 1 ? "s" : ""}
                  </p>
                </div>
                {/* Earnings */}
                <div className="text-right flex-shrink-0">
          ...
          >
            <div className="flex items-start gap-2" style={{ color: C.g400 }}>
              <Trophy
                size={16}
                strokeWidth={2.2}
              ...
              <p className="text-xs">
                Top {leaderboard.length} affiliate earner
                {leaderboard.length !== 1 ? "s" : ""} on PRAQEN. Could you be
                next?
              </p>
            </div>
          </div>
            ...
            {totalEarnings > 0 ? (
              <div
                ...
                style={{
                  ...
                  border: `1px dashed ${C.success}40`,
                }}
              >
                ...
                >
                  {btcPrice > 0
                    ? `≈ $${(totalEarnings * btcPrice).toFixed(2)} USD · `
                    : ""}
              ...
              <div className="text-center py-4">
                ...
                <p className="text-xs mb-4" style={{ color: C.g400 }}>
                  Share your referral link to start earning BTC commissions.
                </p>
                <button
                  onClick={copy}
...
function WithdrawModal({ balance, onClose, onSuccess }) {
  ...
  const submit = async () => {
    if (!address.trim()) {
      toast.error("Enter a Bitcoin address");
      return;
    }
    ...
    try {
      ...
      toast.error(e.response?.data?.error || "Withdrawal failed");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-5 space-y-3">
          ...
          >
            <AlertCircle
              size={12}
              style={{ color: C.warn, flexShrink: 0, marginTop: 1 }}
            />
...
export default function Dashboard({ user }) {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        const freshReferrals =
          res.data.referralCount != null
            ? res.data.referralCount
            : res.data.referredUsers?.length || 0;
        const freshTrades =
          res.data.tradeCount != null
            ? res.data.tradeCount
            : res.data.earnings?.length || 0;
  ...
  const fetchTrades = async () => {
    ...
    try {
      const [activeRes, allRes] = await Promise.all([
        axios.get(`${API_URL}/trades/active`, {
          headers: { Authorization: `Bearer ${token}` },
        }),
        axios.get(`${API_URL}/my-trades?limit=50`, {
          headers: { Authorization: `Bearer ${token}` },
        }),
      ]);
    ...
    return (
      ...
      >
        <div className="text-center px-6">
          ...
          <p className="font-black text-sm mb-2" style={{ color: C.g800 }}>
            Could not load dashboard
          </p>
          <p className="text-xs mb-5" style={{ color: C.g500 }}>
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div
        className="border-b bg-white sticky z-30"
          ...
          {TABS.map(({ id, label, icon: Icon }) => (
            <button
              ...
              style={{
                ...
                backgroundColor:
                  activeTab === id ? `${C.green}06` : "transparent",
              }}
            >
              <Icon size={12} />
              {label}
              {id === "trades" && stats.pendingTrades > 0 && (
                <span
                  className="w-4 h-4 rounded-full text-white text-xs font-black flex items-center justify-center"
              ...
              {id === "affiliate" && stats.totalReferrals > 0 && (
                <span
                  className="px-1.5 h-4 rounded-full text-white text-xs font-black flex items-center justify-center"
                  style={{ backgroundColor: C.purple, fontSize: 10 }}
                >
      ...
      <div className="max-w-6xl mx-auto px-4 py-5 space-y-5">
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <StatCard
                ...
                color={C.success}
                sub={`${stats.totalTrades > 0 ? Math.round((stats.completedTrades / stats.totalTrades) * 100) : 0}% completion`}
              />
              <StatCard
                icon={Clock}
                label="Pending"
                value={fmt(stats.pendingTrades)}
                color={C.warn}
                onClick={() => setActiveTab("trades")}
              />
              <StatCard
              ...
              <StatCard
                icon={Users}
                label="Referrals"
                value={fmt(stats.totalReferrals)}
                color={C.purple}
              ...
              <StatCard
                icon={Bitcoin}
                label="BTC Earned"
                value={`₿ ${parseFloat(stats.referralEarnings || 0).toFixed(6)}`}
                color={C.success}
                onClick={() => setActiveTab("affiliate")}
                sub={
                  btcPrice > 0
                    ? `≈ $${(parseFloat(stats.referralEarnings || 0) * btcPrice).toFixed(2)} USD`
                    : "Affiliate earnings"
                }
              />
            </div>
                    ...
                    {!hasActive && !hasRecent ? (
                      <div className="p-8 text-center">
                        ...
                        <p className="text-xs mb-3" style={{ color: C.g400 }}>
                          Start your first trade to see activity here
                        </p>
                        <button
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg,#3B1F6B,#5B21B6,#7C3AED)",
              }}
            >
              <div className="p-4 md:p-5">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      >
                        Earn BTC every time a referral trades
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  ...
                  >
                    <p className="text-sm font-black text-white">
                      ₿ {parseFloat(stats.referralEarnings || 0).toFixed(6)}
                    </p>
                    <p
                      className="text-xs mt-0.5"
                      style={{ color: "rgba(255,255,255,0.6)" }}
                  ...
                  >
                    <p className="text-sm font-black text-white">
                      {btcPrice > 0
                        ? `$${(parseFloat(stats.referralEarnings || 0) * btcPrice).toFixed(2)}`
                        : "--"}
                    </p>
                    <p
                      className="text-xs mt-0.5"
                ...
                {stats.totalReferrals === 0 && (
                  <p
                    ...
                    style={{ color: "rgba(255,255,255,0.55)" }}
                  >
                    Share your link — when friends sign up and trade, you earn{" "}
                    <strong style={{ color: "#FDE68A" }}>0.1–0.3% BTC</strong>{" "}
                ...
                <div className="p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p
                      ...
                      style={{ color: "#4C1D95" }}
                    >
                      Did you know? You can earn Bitcoin just by sharing your
                      link!
                    </p>
                    <p
                      ...
                      style={{ color: "#6D28D9" }}
                    >
                      Invite friends to PRAQEN — when they trade, you earn{" "}
                      <strong>0.1–0.3% commission</strong> in BTC automatically.
                      No limits.
                    </p>
                  </div>
                  <div
                    className="flex items-center gap-1 text-xs font-black flex-shrink-0 px-3 py-1.5 rounded-xl"
        ...
        {activeTab === "overview" && (
          ...
          >
            ...
            <div className="p-3 grid grid-cols-2 md:grid-cols-4 gap-2">
              ...
              ].map(({ label, icon: Icon, route, tab, color, sub }) => (
                <button
                  key={label}
                  onClick={() => {
                    tab ? setActiveTab(tab) : navigate(route);
                  }}
          ...
          >
            <div className="px-5 py-4 border-b" style={{ borderColor: C.g100 }}>
              ...
              <div className="flex gap-3 text-xs mt-2">
                {[
                  {
                    label: `${recentTrades.filter((t) => t.status === "COMPLETED").length} Completed`,
                    color: C.success,
                  },
                  { label: `${activeTrades.length} Active`, color: C.warn },
                  { label: `${recentTrades.length} Total`, color: C.paid },
                ].map(({ label, color }) => (
                  <span key={label} className="font-bold" style={{ color }}>
                    {label}
                  </span>
                ))}
              </div>
                ...
                return (
                  ...
                  >
                    <div
                      className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0"
                      style={{
                        backgroundColor: `${isBuyer ? C.green : C.amber}15`,
                      }}
                    >
                      <Bitcoin
                        size={15}
                        style={{ color: isBuyer ? C.green : C.amber }}
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className="text-xs font-bold px-1.5 py-0.5 rounded-full text-white"
                          style={{
                            backgroundColor: isBuyer ? C.green : C.amber,
                          }}
                        >
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      >
                        <SI size={9} className="inline mr-0.5" />
                        {s.text}
                      </span>
                    </div>
                  </div>
            ...
            >
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: C.g500 }}
                >
                  When you sell Bitcoin, funds are held in escrow until the
                  buyer confirms payment. Once confirmed, Bitcoin is released to
                  your wallet. Withdrawals are processed within 30 minutes.
                </p>
              </div>
            </div>
          </div>
        ...
        {activeTab === "affiliate" && (
          <AffiliateSection
            ...
            btcPrice={btcPrice}
            onWithdraw={handleReferralWithdraw}
            dbReferralCount={stats.totalReferrals}
            dbTotalEarnings={parseFloat(stats.referralEarnings || 0)}
            dbReferralTrades={stats.referralTrades || 0}
      ...
      <footer className="mt-8" style={{ backgroundColor: C.forest }}>
        <div className="max-w-6xl mx-auto px-4 pt-10 pb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                <div
                  className="w-9 h-9 rounded-xl flex items-center justify-center font-black text-xl"
                  style={{ backgroundColor: C.gold, color: C.forest }}
                >
                  P
                </div>
              ...
              >
                The world's most trusted peer-to-peer Bitcoin trading platform.
                Escrow-protected. Fast. Honest.
              </p>
              {/* Social icons */}
          ...
          {/* Bottom bar */}
          <div
            className="flex flex-col md:flex-row items-center justify-between gap-2 pt-5 border-t"
            style={{ borderColor: "rgba(255,255,255,0.08)" }}
          >
            <p className="text-xs" style={{ color: "rgba(255,255,255,0.3)" }}>
              © {new Date().getFullYear()} PRAQEN. All rights reserved. Built
              with honesty.
            </p>
            <p
