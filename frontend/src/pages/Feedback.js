  ...
  const loadData = async () => {
    try {
      ...
      try {
        ...
        const existing = feedbackRes.data.reviews?.find(
          (r) => r.trade_id === tradeId,
        );
        if (existing) {
            ...
            <div className="flex justify-center mb-2">
              {existingFeedback.rating >= 4 ? (
                <span className="flex items-center gap-2 text-emerald-600 font-black text-sm">
                  <ThumbsUp size={20} className="fill-emerald-500" />
                  Positive
                </span>
              ) : (
                <span className="flex items-center gap-2 text-rose-600 font-black text-sm">
                  <ThumbsDown size={20} className="fill-rose-500" />
                  Negative
                </span>
              )}
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              <p className="text-gray-400 font-bold uppercase text-[10px] tracking-widest mb-2">
                Rate Your Trade
              </p>
              <h2
            ...
            {isPositive !== null && (
              <p
                className={`text-center text-sm font-bold mb-4 flex items-center justify-center gap-2 ${
            ...
            <button
              ...
              style={{
                backgroundColor:
                  isPositive === false ? "#EF4444" : PRAQEN.primary,
                color: "#fff",
              }}
            >
