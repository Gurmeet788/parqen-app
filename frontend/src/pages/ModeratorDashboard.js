...
const resBadge = (res) => {
  ...
  return (
    <span
      className="px-3 py-1 rounded-full text-sm font-bold inline-flex items-center gap-1.5"
      ...
      <div className="max-w-md mx-auto sm:max-w-none sm:w-full px-4 py-4 flex items-center justify-center sm:justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            >
              <span style={{ color: "#fff" }}>PRA</span>
              <span style={{ color: P.secondary }}>QEN</span>
            </p>
            <p
        ...
        {onLogout && (
          <button
            onClick={onLogout}
            title="Logout"
            className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-lg transition"
            style={{ backgroundColor: "rgba(239,68,68,0.15)" }}
          >
            <X size={14} style={{ color: "#f87171" }} />
            <span className="text-xs font-black" style={{ color: "#f87171" }}>
              Logout
            </span>
          </button>
        )}
...
function ModeratorLogin({ onLogin, user }) {
  ...
  useEffect(() => {
    if (isAuthorized) {
      ...
      if (tok) {
        ...
        onLogin(user.username || "PRAQEN Moderator");
      }
    }
  }, [user]);
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="text-center">
            <div
              ...
              style={{ borderColor: P.purple, borderTopColor: P.secondary }}
            />
            <p className="font-bold" style={{ color: P.primary }}>
              Authenticating…
            </p>
          </div>
        </div>
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const r = await axios.post(`${API_URL}/auth/verify-login-otp`, {
        email: pendingEmail,
        code: otp,
      });
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          {hasSession && !isAuthorized && (
            ...
            >
              ...
              <button
                ...
                className="flex-shrink-0 px-3 py-1.5 rounded-lg text-xs font-black text-white"
          ...
          <div
            className="bg-white rounded-2xl shadow-2xl p-8 border-t-4"
              ...
              <>
                <div className="text-center mb-8">
                  <div
                    ...
                    style={{ backgroundColor: P.purpleLight }}
                  >
                    <Shield size={32} style={{ color: P.purple }} />
                  </div>
                  <h1
                    className="text-2xl font-black"
                    style={{ color: P.darkBg }}
                  >
                    Moderator Sign In
                  </h1>
                ...
                <p className="flex items-center justify-center gap-1.5 text-center text-xs text-gray-400 mt-6">
                  <ShieldAlert size={14} />
                  <span>
                    Restricted access — all actions are permanently logged.
                  </span>
                </p>
              </>
            ) : (
...
function ConfirmResolutionModal({
  ...
  const cfg = {
    ...
    CANCEL: {
      ...
      bg: "#FEF2F2",
      borderColor: "#FCA5A5",
      action: "Refund Escrow to Seller",
    },
  }[decision] || {
    label: decision,
    Icon: Scale,
  ...
  return (
    ...
    >
      ...
      >
        {/* Header band */}
        <div
          className="px-6 py-5 flex items-center gap-3 flex-shrink-0"
          style={{
            backgroundColor: cfg.bg,
            borderBottom: `3px solid ${cfg.borderColor}`,
          }}
        >
          <div
          ...
          >
            {cfg.Icon && <cfg.Icon size={24} style={{ color: cfg.color }} />}
          </div>
          <div>
            <p
          ...
          <span
            className="ml-auto text-xs font-mono font-bold px-3 py-1 rounded-full"
        ...
        <div className="px-6 py-5 space-y-4 overflow-y-auto flex-1">
          ...
          <div
            ...
            style={{ backgroundColor: "#faf5ff", borderColor: "#c4b5fd" }}
          >
            <Shield
              size={14}
              style={{ color: P.purple, flexShrink: 0, marginTop: 2 }}
            />
            <p
              className="text-sm font-semibold"
              style={{ color: P.purpleDark }}
            >
              This is your own independent vote as <strong>{modName}</strong> —
              signed under the Moderator Oath of Trust you already swore. It
              does not resolve anything by itself; escrow only moves once{" "}
              {quorum || 3} moderators agree.
            </p>
          </div>
        </div>
        ...
        >
          ...
          >
            {submitting ? (
              <>
                <RefreshCw size={14} className="animate-spin" /> Casting…
              </>
            ) : (
              <>
                <Gavel size={14} /> Confirm Your Vote
              </>
            )}
          </button>
        </div>
...
function OathScreen({ user, onSigned }) {
  ...
  const sign = async () => {
    ...
    try {
      ...
      toast.error(e.response?.data?.error || "Failed to sign oath");
    }
    setSigning(false);
  };
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: P.lightBg }}>
      ...
      <div className="py-10 px-4">
        <div
          className="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border-t-4"
          style={{ borderColor: P.purple }}
        >
          ...
          >
            ...
            <div>
              <h1
                ...
                style={{ color: P.purpleDark }}
              >
                Moderator Oath of Trust
              </h1>
              <p className="text-sm text-gray-600 font-semibold mt-0.5">
                Required before you can review or vote on any dispute
              </p>
            </div>
          </div>
          ...
          <div className="px-8 py-6 space-y-5">
            <p
              className="text-sm leading-relaxed p-4 rounded-xl border-l-4"
              style={{
            ...
            >
              Every verdict you cast releases or withholds real Bitcoin that
              belongs to real people. This oath exists so every trader on PRAQEN
              can trust the outcome — no matter which of you reviewed it, and no
              matter who they are to you.
            </p>
            ...
            <p className="text-xs text-gray-400 -mt-3">
              This is exactly what will show on every vote and comment you make
            ...
            <label
              ...
              style={{
                borderColor: agree ? P.purple : "#e5e7eb",
                backgroundColor: agree ? "#faf5ff" : "white",
              }}
            >
              <input
                type="checkbox"
                ...
                className="mt-0.5 accent-purple-600 w-4 h-4 flex-shrink-0 cursor-pointer"
              />
              <p
                className="text-sm font-bold"
                style={{ color: agree ? P.purpleDark : "#374151" }}
              >
                I have read all six points above, and I sign this oath knowing
                my name and email will appear on every verdict and comment I
                make from this account.
              </p>
            </label>

            <button
              onClick={sign}
              disabled={!agree || !fullName.trim() || !email.trim() || signing}
            ...
            >
              {signing ? (
                ...
                <>
                  <Shield size={14} /> Sign Oath &amp; Enter Dispute Queue
                </>
              )}
            </button>
          </div>
  ...
  return (
    <div className="grid sm:grid-cols-2 gap-3">
      {moderators.map((m) => {
        ...
        if (v && v.vote) {
          const isBuyer = v.vote === "BUYER_WINS",
            isSeller = v.vote === "SELLER_WINS";
          stateLabel =
            v.vote === "CANCEL"
              ? "Voted · Cancel Trade"
              : isBuyer
          ...
          cardStyle = {
            backgroundColor: isBuyer
              ...
              : isSeller
                ? "#EFF6FF"
                : "#FEF2F2",
            borderColor: isBuyer ? "#6EE7B7" : isSeller ? "#93C5FD" : "#FCA5A5",
          };
          icon = (
            <CheckCircle
              size={14}
              style={{
                color: isBuyer ? P.success : isSeller ? P.info : P.danger,
              }}
            />
          );
        } else if (v) {
...
function TeamDiscussion({ tradeId }) {
  ...
  const load = async () => {
    try {
      const r = await axios.get(
        `${API_URL}/admin/disputes/${tradeId}/comments`,
        { headers: authH() },
      );
  ...
  const post = async (e) => {
    ...
    try {
      await axios.post(
        `${API_URL}/admin/disputes/${tradeId}/comments`,
        { message: text.trim(), parent_id: replyTo },
        { headers: authH() },
      );
      setText("");
      setReplyTo(null);
  ...
  const renderThread = (parentKey = "root", depth = 0) =>
    (byParent[parentKey] || []).map((c) => (
      <div key={c.id} style={{ marginLeft: depth * 24 }} className="mb-3">
        <div
          className="rounded-xl border p-3"
          style={{
            backgroundColor: c.is_admin_override ? "#FFFBEB" : "#f9fafb",
            borderColor: c.is_admin_override ? "#FDE68A" : "#e5e7eb",
          }}
        >
          <div className="flex items-center gap-2 flex-wrap mb-1">
            <span
              className="text-xs font-black"
              style={{ color: c.is_admin_override ? P.gold : P.purpleDark }}
            >
            ...
            {c.is_admin_override && (
              <span
                ...
                style={{ backgroundColor: P.gold, color: "white" }}
              >
                Admin Override
              </span>
            )}
      ...
      {comments.length === 0 ? (
        <div className="text-center py-10">
          ...
          <p className="text-gray-400 font-semibold text-sm">
            No team notes yet — be the first to weigh in
          </p>
        </div>
      ) : (
        renderThread()
      ...
      <form onSubmit={post} className="mt-4 space-y-2">
        {replyTo && (
          <div
            ...
            style={{ backgroundColor: P.purpleLight, color: P.purpleDark }}
          >
            Replying to a note{" "}
            <button
              type="button"
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Add your note for the team…"
            className="flex-1 px-3 py-2.5 border-2 rounded-xl text-sm outline-none"
            style={{ borderColor: text ? P.purple : "#e5e7eb" }}
          />
          <button
            type="submit"
...
function DisputeModal({
  ...
  const loadChat = async () => {
    try {
      const r = await axios.get(`${API_URL}/messages/${dispute.trade_id}`, {
        headers: authH(),
      });
  ...
  const loadImages = async () => {
    try {
      const r = await axios.get(
        `${API_URL}/trades/${dispute.trade_id}/images`,
        { headers: authH() },
      );
  ...
  const loadStats = async () => {
    try {
      if (dispute.buyer?.id) {
        const r = await axios.get(`${API_URL}/users/${dispute.buyer.id}`, {
          headers: authH(),
        });
        setBuyerStats(r.data.user || r.data);
        try {
          const rv = await axios.get(
            `${API_URL}/users/${dispute.buyer.id}/reviews`,
            { headers: authH() },
          );
          setBuyerReviews(rv.data.reviews || []);
        } catch {
          setBuyerReviews([]);
        }
        try {
          const dh = await axios.get(
            `${API_URL}/admin/users/${dispute.buyer.id}/dispute-history`,
            { headers: authH() },
          );
          setBuyerDisputes(dh.data);
        } catch {
          setBuyerDisputes(null);
        }
      }
      if (dispute.seller?.id) {
        const r = await axios.get(`${API_URL}/users/${dispute.seller.id}`, {
          headers: authH(),
        });
        setSellerStats(r.data.user || r.data);
        try {
          const rv = await axios.get(
            `${API_URL}/users/${dispute.seller.id}/reviews`,
            { headers: authH() },
          );
          setSellerReviews(rv.data.reviews || []);
        } catch {
          setSellerReviews([]);
        }
        try {
          const dh = await axios.get(
            `${API_URL}/admin/users/${dispute.seller.id}/dispute-history`,
            { headers: authH() },
          );
          setSellerDisputes(dh.data);
        } catch {
          setSellerDisputes(null);
        }
      }
    } catch {}
  };
  ...
  const loadVoteData = async () => {
    ...
    try {
      const r = await axios.get(
        `${API_URL}/admin/disputes/${dispute.trade_id}`,
        { headers: authH() },
      );
      setVoteData(r.data);
    } catch {}
  ...
  const loadModerators = async () => {
    try {
      const r = await axios.get(`${API_URL}/team/moderators`, {
        headers: authH(),
      });
      setModerators(r.data.moderators || []);
    } catch {}
  };
  ...
  const joinChat = async () => {
    try {
      await axios.post(
        `${API_URL}/trades/${dispute.trade_id}/moderator-join`,
        {},
        { headers: authH() },
      );
    } catch {}
  ...
  const sendMessage = async (e) => {
    ...
    try {
      await axios.post(
        `${API_URL}/messages`,
        { tradeId: dispute.trade_id, message: newMessage.trim() },
        { headers: authH() },
      );
      setNewMessage("");
      loadChat();
  ...
  const openConfirm = (decision) => {
    if (!resolutionNotes.trim()) {
      toast.error("You must write your decision notes before confirming.");
      return;
    }
  ...
  const handleConfirmResolve = async () => {
    ...
    try {
      const r = await axios.post(
        `${API_URL}/admin/disputes/${dispute.trade_id}/resolve`,
        {
      ...
      toast.error(e.response?.data?.error || "Failed to submit your vote");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const submitOverride = async (decision) => {
    if (!overrideReason.trim()) {
      toast.error("Write a reason before overriding.");
      return;
    }
    if (
      !window.confirm(
        `Confirm admin override: ${decision.replace(/_/g, " ")}? This is logged and visible to the whole team.`,
      )
    )
      return;
    ...
    try {
      await axios.post(
        `${API_URL}/admin/disputes/${dispute.trade_id}/override`,
        { resolution: decision, reason: overrideReason.trim() },
        { headers: authH() },
      );
      toast.success(
        `Resolved by admin override: ${decision.replace(/_/g, " ")}`,
      );
      onResolved();
    } catch (e) {
  ...
  const tabs = readOnly
    ? [
        { id: "details", Icon: ClipboardList, l: "Details" },
        { id: "user-history", Icon: Users, l: "Profiles" },
        { id: "evidence", Icon: Paperclip, l: `Evidence (${images.length})` },
        { id: "chat", Icon: MessageCircle, l: "Chat History" },
        { id: "discussion", Icon: MessagesSquare, l: "Team Discussion" },
        { id: "ruling", Icon: Scale, l: "Ruling" },
      ]
    : [
        { id: "details", Icon: ClipboardList, l: "Details" },
        { id: "user-history", Icon: Users, l: "User History" },
        { id: "evidence", Icon: Paperclip, l: `Evidence (${images.length})` },
        { id: "chat", Icon: MessageCircle, l: "Live Chat" },
        { id: "discussion", Icon: MessagesSquare, l: "Team Discussion" },
        { id: "resolve", Icon: Scale, l: "Resolve" },
      ];
    ...
    <>
      ...
      <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl w-full max-w-5xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p
                  className="text-xs font-black uppercase tracking-widest"
                  style={{ color: readOnly ? P.success : P.purple }}
                >
                  {readOnly
                    ? "Resolved Dispute — Read Only"
                    : "Active Dispute Review"}
                </p>
              ...
              {readOnly &&
                resBadge(dispute.resolution || dispute.dispute_resolution)}
            </div>
            <button
              onClick={onClose}
          ...
          {/* Tabs */}
          <div
            className="border-b px-6 flex gap-0 overflow-x-auto bg-gray-50 flex-shrink-0"
            style={{ borderColor: "#e5e7eb" }}
          >
            {tabs.map(({ id, l, Icon }) => (
              <button
                ...
                className={`flex items-center gap-2 py-3 px-4 text-sm font-bold whitespace-nowrap border-b-2 transition ${
                  activeTab === id
          ...
          <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="space-y-5">
                <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                  ...
                  <p className="text-sm text-red-500 mt-1 font-semibold">
                    Opened: {fmtDate(dispute.created_at)}
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      rows: [
                        {
                          l: "BTC Amount",
                          v: `₿ ${fmtBtc(dispute.trade_details?.amount_btc)}`,
                        },
                        {
                          l: "USD Amount",
                          v: fmtUsd(dispute.trade_details?.amount_usd),
                        },
                        {
                          l: "Status",
                          v: dispute.trade_details?.status || "DISPUTED",
                        },
                        {
                          l: "Started",
                          v: fmtDate(dispute.trade_details?.created_at),
                        },
                      ],
                    },
                    {
                      ...
                      rows: [
                        {
                          l: "Method",
                          v: dispute.trade_details?.payment_method || "—",
                        },
                        {
                          l: "Buyer Confirmed",
                          v: dispute.trade_details?.buyer_confirmed
                            ? "Yes"
                            : "No",
                          Icon: dispute.trade_details?.buyer_confirmed
                            ? CheckCircle2
                            : Clock3,
                        },
                        {
                          l: "Sent At",
                          v: fmtDate(dispute.trade_details?.buyer_confirmed_at),
                        },
                      ],
                    },
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-2 text-base font-bold text-blue-700">
                    ...
                    <span>
                      ₿{fmtBtc(dispute.trade_details?.amount_btc)} locked in
                      escrow.{" "}
                      {readOnly
                        ? "Dispute resolved."
            ...
            {activeTab === "user-history" && (
              <div className="space-y-5">
                {[
                  ...
                  const joinedDays = stats?.created_at
                    ? Math.floor(
                        (Date.now() - new Date(stats.created_at)) / 86400000,
                      )
                    : null;
                  const joinedAgo =
                    joinedDays == null
                      ...
                      : joinedDays < 30
                        ? `${joinedDays}d ago`
                        : joinedDays < 365
                          ? `${Math.floor(joinedDays / 30)}mo ago`
                          : `${(joinedDays / 365).toFixed(1)}yr ago`;
                  const lastActive = stats?.last_seen_at || stats?.last_login;
                  return (
                    <div key={role} className={`${bg} rounded-xl p-5 border`}>
                      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                        <h3 className="font-black text-lg" style={{ color }}>
                          {role}: {d?.username || "Unknown"}
                        </h3>
                        {stats?.badge && (
                          <span
                            className="text-xs font-black uppercase px-2.5 py-1 rounded-full"
                            style={{
                              backgroundColor: badgeColor(stats.badge).bg,
                              color: badgeColor(stats.badge).c,
                            }}
                          >
                            {stats.badge}
                          </span>
                        ...
                        {stats?.account_status &&
                          stats.account_status !== "active" && (
                            <span className="text-xs font-black uppercase px-2.5 py-1 rounded-full bg-red-100 text-red-700">
                              {stats.account_status}
                            </span>
                          )}
                      </div>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-white rounded-xl p-4 border">
                          <div className="flex items-center gap-2 mb-3">
                            <ChartColumn size={16} className="text-gray-700" />
                          ...
                          {[
                            ...
                            {
                              l: "Completion Rate",
                              v: `${parseFloat(stats?.completion_rate || 0).toFixed(1)}%`,
                            },
                            {
                              l: "Rating",
                              v: (
                            ...
                            {
                              l: "Joined",
                              v: `${fmtDate(stats?.created_at)?.split(",")[0] || "—"} (${joinedAgo})`,
                            },
                            {
                              l: "Referrals Made",
                              v: stats?.total_referrals || 0,
                            },
                            {
                              l: "Last Active",
                              v: lastActive ? fmtAge(lastActive) : "—",
                            },
                        ...
                        <div className="bg-white rounded-xl p-4 border">
                          ...
                          {[
                            {
                              l: "Email Verified",
                              v: stats?.is_email_verified,
                            },
                            {
                              l: "Phone Verified",
                              v: stats?.is_phone_verified,
                            },
                            ...
                            >
                              ...
                              <span
                                ...
                                style={{ color: v ? P.success : "#9ca3af" }}
                              >
                                {v ? (
                                  <UserCheck size={13} />
                                ) : (
                        ...
                        <div className="bg-white rounded-xl p-4 border">
                          <div className="flex items-center gap-2 mb-3">
                            <Scale size={16} className="text-gray-700" />
                            <p className="font-black text-sm text-gray-700">
                              Dispute Record
                            </p>
                          </div>
                          {disputes == null ? (
                            ...
                            <div className="flex items-center gap-2 py-1">
                              ...
                              <p
                                ...
                                style={{ color: P.success }}
                              >
                                Clean record — never been in a dispute before
                              </p>
                            </div>
                          ) : (
                            <>
                              ...
                              {disputes.losses > 0 && (
                                <p
                                  ...
                                  style={{ color: P.danger }}
                                >
                                  <AlertTriangle size={12} /> Has lost{" "}
                                  {disputes.losses} past dispute
                                  {disputes.losses > 1 ? "s" : ""} — worth
                                  weighing in this review.
                                </p>
                              )}
                            </>
                          )}
                        ...
                        <div className="bg-white rounded-xl p-4 border">
                          <p className="font-black text-sm mb-3 text-gray-700">
                            Recent Feedback
                          </p>
                          {reviews.length === 0 ? (
                            ...
                            reviews.slice(0, 3).map((rv, i) => (
                              ...
                              >
                                <div className="flex gap-0.5 mb-1">
                                  {getRatingStars(rv.rating)}
                                </div>
                                <p className="text-xs text-gray-600 font-medium">
                                  {rv.comment?.substring(0, 80)}…
                                </p>
                              </div>
                            ))
                          )}
              ...
              (images.length === 0 ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {images.map((img, i) => (
                    <div
                      key={i}
                      className="border-2 rounded-xl overflow-hidden cursor-pointer hover:shadow-lg transition"
                      onClick={() => setZoomImg(img.image_url || img.url)}
                    >
                      <img
            ...
            {/* ── CHAT ── */}
            {(activeTab === "chat" || activeTab === "resolve") &&
              activeTab === "chat" && (
                <div className="flex flex-col" style={{ height: 500 }}>
                  {!readOnly && !modJoined && (
                    <div className="bg-purple-50 border border-purple-200 rounded-xl p-5 mb-4 text-center">
                      ...
                      />
                      <p className="font-black text-purple-800 mb-3">
                        Your messages will appear with a special MODERATOR badge
                        visible to both parties
                      </p>
                      <button
                        onClick={joinChat}
                        className="px-6 py-2.5 rounded-xl text-white font-black text-sm flex items-center gap-2"
                        style={{ backgroundColor: P.purple }}
                      >
                        <UserRound size={18} />
                        Join Dispute Chat
                  ...
                  {(readOnly || modJoined) && (
                    <div
                      className="flex items-center gap-2 px-4 py-2 rounded-xl mb-3 border"
                      style={{
                    ...
                    >
                      ...
                      >
                        {readOnly
                          ? "Viewing resolved dispute chat — read only"
                          : `You are live in this chat as MODERATOR · ${modName}`}
                      </p>
                    </div>
                  )}
                  <div
                    className="flex-1 overflow-y-auto space-y-3 rounded-xl p-4 border min-h-0"
                      ...
                      chatMessages.map((m, i) => {
                        ...
                        if (isSys) {
                          const isModJoinMsg =
                            ...
                            text.includes("moderator");
                          const isRulingMsg =
                            text.includes("BUYER_WINS") ||
                            text.includes("SELLER_WINS") ||
                          ...
                          return (
                            <div key={i} className="flex justify-center">
                              <div className="bg-gray-200 text-gray-600 px-4 py-2 rounded-xl text-sm font-medium max-w-[85%] text-center">
                                {text}
                              </div>
                            </div>
                          );
                        ...
                        if (isMod)
                          return (
                            <div key={i} className="flex justify-center">
                              <div
                                className="w-full max-w-[90%] rounded-2xl overflow-hidden shadow-lg border-2"
                                style={{ borderColor: P.purple }}
                              >
                                {/* Authority header */}
                                <div
                                  className="flex items-center gap-2 px-4 py-2.5"
                                  style={{
                                    background: `linear-gradient(90deg,${P.purpleDark},${P.purple})`,
                                  }}
                                >
                                  <div
                                ...
                                >
                                  <span className="text-xs font-black text-purple-500 uppercase tracking-widest">
                                    Praqen Dispute Resolution · Moderator
                                    Statement
                                  </span>
                                </div>
                              </div>
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`max-w-[70%] rounded-2xl border overflow-hidden`}
                              style={{
                                backgroundColor: isBuyer ? "white" : "#f0fdf4",
                                borderColor: isBuyer ? "#e5e7eb" : "#86efac",
                              }}
                            >
                              <div
                              ...
                              >
                                ...
                                <span
                                  ...
                                  style={{
                                    color: isBuyer ? P.primary : P.info,
                                  }}
                                >
                                  {isBuyer ? (
                                    <User size={14} />
                    ...
                    >
                      <div className="flex-1 relative">
                        <input
                          ...
                          style={{
                            borderColor: newMessage ? P.purple : "#e5e7eb",
                          }}
                        />
                        <Shield
                          size={14}
            ...
            {activeTab === "resolve" && !readOnly && (
              <div className="space-y-5">
                ...
                >
                  <h3
                    className="font-black mb-3 flex items-center gap-2"
                    style={{ color: P.purpleDark }}
                  >
                    <Shield size={18} /> Before You Vote
                  </h3>
                  <ul className="space-y-1.5">
                    {[
                      "Review all uploaded evidence (Evidence tab)",
                      "Read the full chat history (Chat tab)",
                      "Read the Team Discussion tab — and add your own notes",
                      "Check both user trade profiles",
                      "Write clear notes explaining your reasoning",
                    ].map((p) => (
                      <li
                        key={p}
                        className="text-sm font-semibold"
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-gray-50 rounded-xl border">
                  {[
                    ...
                    {
                      l: "Buyer",
                      v: dispute.buyer?.username || "—",
                      c: P.primary,
                    },
                    {
                      l: "Seller",
                      v: dispute.seller?.username || "—",
                      c: P.info,
                    },
                  ].map(({ l, v, c }) => (
                    <div
                      key={l}
                      className="text-center bg-white p-3 rounded-xl border"
                    >
                      <p className="text-xs font-bold text-gray-500 uppercase mb-1">
                        {l}
                      </p>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-black text-gray-700 flex items-center gap-2">
                      <Users size={15} /> Verdict Votes
                    </p>
                    <span className="text-xs font-black text-gray-500">
                      {voteData.is_split
                        ? "Tied — no majority"
                        : `${Math.max(...Object.values(voteData.tally || {}), 0)} of ${voteData.quorum || 3} needed`}
                    </span>
                  </div>
                  <div className="h-1.5 rounded-full bg-gray-100 overflow-hidden mb-3">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: voteData.is_split
                          ? P.danger
                          : P.purple,
                      }}
                    />
                ...
                {voteData.is_split && (
                  ...
                  >
                    <Clock
                      size={16}
                      style={{ color: P.gold, flexShrink: 0, marginTop: 2 }}
                    />
                    <p
                      className="text-sm font-bold"
                      style={{ color: "#92400E" }}
                    >
                      The panel is tied with no majority — this case is
                      escalated for an admin decision.
                    </p>
                  </div>
                )}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    style={{
                      borderColor: resolutionNotes ? P.purple : "#e5e7eb",
                    }}
                  />
                  <p
                    className="text-xs mt-1 font-semibold"
                    style={{ color: resolutionNotes ? P.success : "#9ca3af" }}
                  >
                    {resolutionNotes
                      ? `${resolutionNotes.length} chars — ready to submit`
                      : "Required before you can cast your vote"}
                  </p>
                </div>
                <div className="grid md:grid-cols-3 gap-4">
                  {[
                    ...
                    },
                    {
                      label: "Cancel Trade",
                      Icon: XCircle,
                      sub: "Refund escrow to seller",
                      decision: "CANCEL",
                      color: P.danger,
                      bg: "#FEF2F2",
                      border: "#FCA5A5",
                    },
                  ].map(({ label, Icon, sub, decision, color, bg, border }) => (
                    <button
                      key={decision}
                    ...
                    >
                      ...
                      <p className="text-xs mt-2 font-bold text-gray-400">
                        Cast your vote →
                      </p>
                    </button>
                  ))}
                ...
                <div className="flex items-start gap-2 p-4 rounded-xl bg-blue-50 border border-blue-200">
                  ...
                  <p className="text-sm font-bold text-blue-700">
                    Your vote alone does not resolve this case. Escrow only
                    moves once {voteData.quorum || 3} moderators agree on the
                    same outcome.
                  </p>
                </div>
                ...
                {isAdmin && (
                  <div
                    ...
                    style={{ backgroundColor: "#FFFBEB", borderColor: P.gold }}
                  >
                    <h3
                      className="font-black mb-1 flex items-center gap-2"
                      style={{ color: "#92400E" }}
                    >
                      <Stamp size={16} /> Admin Override
                    </h3>
                    <p
                      className="text-xs font-semibold mb-3"
                      style={{ color: "#92400E" }}
                    >
                      You can resolve this case directly at any time. Requires a
                      written reason — logged to the team discussion thread.
                    </p>
                    <textarea
                      ...
                      className="w-full px-3 py-2 border-2 rounded-xl text-sm outline-none resize-none mb-3"
                    ...
                    <div className="grid md:grid-cols-3 gap-2">
                      {[
                        ...
                        <button
                          key={decision}
                          onClick={() => submitOverride(decision)}
                          disabled={
                            submittingOverride || !overrideReason.trim()
                          }
                          className="py-2.5 rounded-xl text-white font-black text-xs disabled:opacity-40"
                          style={{ backgroundColor: P.gold }}
                        >
            ...
            {activeTab === "ruling" && readOnly && (
              <div className="space-y-5">
                <div
                  ...
                  style={{
                    borderColor:
                      dispute.resolution === "BUYER_WINS"
                        ? P.success
                        : dispute.resolution === "SELLER_WINS"
                          ? P.info
                          : P.danger,
                  }}
                >
                  <div
                    ...
                    style={{
                      background: `linear-gradient(90deg,${P.gold},${P.warning})`,
                    }}
                  >
                    ...
                    <span className="ml-auto text-xs text-white/70 font-mono">
                      Trade #
                      {(dispute.trade_id || "").slice(0, 8).toUpperCase()}
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <div className="flex items-center gap-3 p-3 rounded-xl border border-amber-200 bg-white flex-wrap">
                      ...
                      <div className="flex-1 min-w-0">
                        <p
                          ...
                          style={{ color: P.purple }}
                        >
                          {dispute.resolved_via === "ADMIN_OVERRIDE"
                            ? "Resolved by admin override: "
                            : "Resolved by consensus of: "}
                          {dispute.resolved_by_name || "PRAQEN Moderator"}
                        </p>
                        {(dispute.resolved_by_list || []).some(
                          (v) => v.email,
                        ) && (
                          <p className="text-xs text-gray-500">
                            {(dispute.resolved_by_list || [])
                              .map((v) => v.email)
                              .filter(Boolean)
                              .join(", ")}
                          </p>
                        ...
                        <p className="text-xs text-gray-500">
                          {fmtDate(dispute.resolved_at || dispute.updated_at)}
                        </p>
                      </div>
                    ...
                    {(dispute.resolution_notes || dispute.dispute_notes) && (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          <NotebookPen size={16} className="text-purple-700" />
                          <p className="text-sm font-black text-purple-700">
                            Moderator's Ruling Notes
                          </p>
                        </div>
...
export default function ModeratorDashboard({ user }) {
  ...
  const checkOath = async () => {
    try {
      const r = await axios.get(`${API_URL}/team/oath-status`, {
        headers: authH(),
      });
      setOathSigned(!!r.data.signed);
    } catch {
      setOathSigned(false);
    }
  };
  useEffect(() => {
    if (loggedIn) checkOath();
  }, [loggedIn]);
  useEffect(() => {
    if (loggedIn && oathSigned) loadAll();
  }, [loggedIn, oathSigned]);
  ...
  if (oathSigned === false)
    return <OathScreen user={user} onSigned={() => setOathSigned(true)} />;

  const open = disputes.filter(
    (d) => d.status === "OPEN" || d.status === "DISPUTED",
  );
  const inReview = disputes.filter((d) => d.status === "IN_REVIEW");
  const totalBtc = resolved.reduce(
    (s, d) => s + parseFloat(d.amount_btc || d.trade_details?.amount_btc || 0),
    0,
  );
  const totalUsd = resolved.reduce(
    (s, d) => s + parseFloat(d.amount_usd || d.trade_details?.amount_usd || 0),
    0,
  );
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-3.5 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-black text-white"
              style={{ backgroundColor: P.purple }}
            >
                ...
                {[
                  {
                    ...
                    bg: "bg-green-50",
                    pts: [
                      "Buyer has valid payment proof",
                      "Seller failed to release BTC",
                      "Seller sent fake/invalid item",
                      "Clear evidence of seller fraud",
                    ],
                  },
                  {
                    title: "Seller Wins",
                    ...
                    bg: "bg-blue-50",
                    pts: [
                      "Buyer never sent payment",
                      "Buyer provided fake proof",
                      "Buyer attempted scam",
                      "Seller provided valid item",
                    ],
                  },
                  {
                    title: "Cancel Trade",
                    ...
                    pts: [
                      ...
                      "Insufficient evidence from both",
                      "Refund BTC to seller",
                    ],
                  },
                ].map(({ title, Icon, c, bg, pts }) => (
                  <div key={title} className={`${bg} rounded-xl p-4`}>
                    <div className={`flex items-center gap-2 ${c} mb-3`}>
                      <Icon size={18} />
            ...
            {[
              {
                ...
                value: open.length,
                color: P.danger,
                sub: open.length > 0 ? "⚡ Needs action" : "✅ All clear",
              },
              {
                icon: Clock,
                label: "In Review",
                    ...
                    <div className="flex justify-between items-start gap-4 flex-wrap">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-x-5 gap-y-1 text-sm text-gray-600">
                          <span>
                            <strong>BTC:</strong> ₿
                            {fmtBtc(d.trade_details?.amount_btc)}
                          </span>
                          <span>
                            <strong>USD:</strong>{" "}
                            {fmtUsd(d.trade_details?.amount_usd)}
                          </span>
                          {d.trade_details?.payment_method && (
                            <span>
                          ...
                          <span>
                            <strong>Buyer:</strong>{" "}
                            {d.buyer?.username || "Unknown"}
                          </span>
                          <span>
                            <strong>Seller:</strong>{" "}
                            {d.seller?.username || "Unknown"}
                          </span>
                        </div>
                      </div>
                      <button
          ...
          {inReview.length > 0 && (
            <div className="bg-white rounded-2xl shadow p-6 mb-6">
              <div className="flex items-center gap-2 mb-6">
                <Clock3 size={24} style={{ color: P.primary }} />
                <h2
                  className="text-2xl font-black"
                  style={{ color: P.primary }}
                >
              ...
              <div className="space-y-4">
                {inReview.map((d) => (
                  <div
                    key={d.id}
                    className="border-2 border-yellow-300 bg-yellow-50 rounded-xl p-4 hover:shadow-md transition"
                  >
                    <div className="flex justify-between items-start gap-4 flex-wrap">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <div className="flex flex-wrap gap-x-5 gap-y-1 text-sm text-gray-600">
                          ...
                          <span>
                            <strong>Buyer:</strong> {d.buyer?.username || "—"} (
                            {d.buyer?.total_trades || 0} trades)
                          </span>
                          <span>
                            <strong>Seller:</strong> {d.seller?.username || "—"}{" "}
                            ({d.seller?.total_trades || 0} trades)
                          </span>
                        </div>
                      </div>
                      <button
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1 font-medium">
                  Full history is kept permanently — click any ruling to review
                  all details, chat, and evidence
                </p>
              </div>
              {resolved.length > 0 && (
                <div className="flex gap-4">
                  {[
                    ...
                    <div
                      key={lbl}
                      className="text-center px-4 py-2 rounded-xl border bg-gray-50"
                    >
            ...
            {resolved.length === 0 ? (
              ...
              <div className="space-y-4">
                {resolved.map((d) => {
                  ...
                  const btcAmt = parseFloat(
                    d.amount_btc || d.trade_details?.amount_btc || 0,
                  );
                  const usdAmt = parseFloat(
                    d.amount_usd || d.trade_details?.amount_usd || 0,
                  );
                  const resColor =
                    res === "BUYER_WINS"
                      ? P.success
                  ...
                  return (
                    <div
                      key={d.id}
                      className="border-2 rounded-2xl overflow-hidden cursor-pointer hover:shadow-lg transition group"
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-sm text-gray-500">
                          Resolved {fmtAge(d.resolved_at || d.updated_at)}
                        </span>
                        <span
                          className="ml-auto flex items-center gap-1.5 text-xs font-bold px-3 py-1 rounded-full border group-hover:bg-white transition"
                          style={{ color: P.purple, borderColor: "#c4b5fd" }}
                        >
                      ...
                      <div className="p-5">
                        <p className="text-base font-black text-slate-900 mb-3">
                          {d.reason || d.dispute_reason || "Dispute resolved"}
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                          {[
                            ...
                            {
                              lbl: "Buyer",
                              val: d.buyer?.username || "—",
                              c: P.primary,
                            },
                            {
                              lbl: "Seller",
                              val: d.seller?.username || "—",
                              c: P.info,
                            },
                          ].map(({ lbl, val, c }) => (
                            <div
                              key={lbl}
                              className="p-3 rounded-xl border text-center bg-gray-50"
                            >
                              <p className="text-xs font-bold text-gray-500 uppercase mb-1">
                                {lbl}
                              </p>
                        ...
                        >
                          ...
                          <p
                            ...
                            style={{ color: P.purple }}
                          >
                            {d.resolved_via === "ADMIN_OVERRIDE"
                              ? "Admin override: "
                              : "Consensus of: "}
                            {d.resolved_by_name || "PRAQEN Moderator"} ·{" "}
                            {fmtDate(d.resolved_at || d.updated_at)}
                          </p>
                          {d.resolved_via && (
                            <span
                              className="ml-auto text-[9px] font-black uppercase px-2 py-0.5 rounded-full text-white"
                              style={{
                                backgroundColor:
                                  d.resolved_via === "ADMIN_OVERRIDE"
                                    ? P.gold
                        ...
                        {(d.resolution_notes || d.dispute_notes) && (
                          ...
                          >
                            ...
                            <p className="text-sm text-purple-800 leading-relaxed line-clamp-2">
                              {d.resolution_notes || d.dispute_notes}
                            </p>
                          </div>
                        )}
