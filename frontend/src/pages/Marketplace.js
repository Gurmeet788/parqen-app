  ...
  const getFilteredListings = () => {
    ...
    if (activeTab === "buy") {
      filtered = filtered.filter(
        (l) => l.listing_type === "SELL_GIFT_CARD" || !l.listing_type,
      );
    } else {
    ...
    if (filters.minPrice) {
      filtered = filtered.filter(
        (l) => l.amount_usd >= parseFloat(filters.minPrice),
      );
    }
    if (filters.maxPrice) {
      filtered = filtered.filter(
        (l) => l.amount_usd <= parseFloat(filters.maxPrice),
      );
    }
          ...
          <div className="flex items-center justify-between mb-4">
              ...
              <div>
                <div className="flex items-center gap-1.5 flex-wrap">
                  <p className="font-bold text-gray-900">
                    {seller.display_name || seller.username || "Anonymous"}
                  </p>
            ...
            {totalTrades > 100 && (
              <div
                ...
                style={{
                  backgroundColor: PRAQEN.lightBg,
                  color: PRAQEN.primary,
                }}
              >
                <Award size={12} />
                Top Trader
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-sm text-gray-600">
                {formatBtc(listing.bitcoin_price)} BTC
              </span>
            </div>
          </div>
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-black" style={{ color: PRAQEN.primary }}>
            P2P Marketplace
          </h1>
        ...
        <div className="flex gap-2 mb-6 bg-white rounded-xl p-1 shadow-sm max-w-md mx-auto">
          <button
            ...
            style={{
              backgroundColor:
                activeTab === "buy" ? PRAQEN.primary : "transparent",
            }}
          >
          ...
          <button
            ...
            style={{
              backgroundColor:
                activeTab === "sell" ? PRAQEN.primary : "transparent",
            }}
          >
            <div className="flex items-center justify-center gap-2">
              <TrendingUp size={18} />
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          {user && activeTab === "sell" && (
            <button
              ...
              style={{
                backgroundColor: PRAQEN.secondary,
                color: PRAQEN.darkBg,
              }}
            >
              <Plus size={16} />
