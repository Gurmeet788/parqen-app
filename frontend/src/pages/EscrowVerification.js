    ...
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-blue-900 text-sm">
          <strong>How it works:</strong> PRAQEN holds the Bitcoin in escrow
          until you verify the gift card code works correctly. Only after
          verification will the Bitcoin be released to the seller.
        </p>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {parseFloat(trade.amount_btc).toFixed(8)} BTC in secure escrow
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Seller has provided the code (encrypted)
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Test the code and confirm it works
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <p className="text-sm text-gray-600 mb-2">
            <strong>Gift Card Code:</strong> (You should have received this in
            chat)
          </p>
          <p className="text-sm text-gray-600 mb-4">
            Test the code on the official {trade.listings?.gift_card_brand}{" "}
            website to ensure it's valid and has the correct balance.
          </p>
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-gray-700">
                ✗ Code doesn't work or balance is wrong
              </span>
            </label>
          </div>
        </div>
      ...
      <div className="flex gap-4">
        <button
          ...
          disabled={
            verifying || codeWorks !== "yes" || !verificationNotes.trim()
          }
        ...
        <button
          ...
          disabled={
            verifying || codeWorks !== "no" || !verificationNotes.trim()
          }
      ...
      <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <p className="text-sm text-yellow-800 flex items-start gap-2">
          ...
          <span>
            <strong>Important:</strong> Only click "Release Bitcoin" after
            thoroughly testing the code. Once released, it cannot be reversed.
            If the code doesn't work, open a dispute immediately.
          </span>
        </p>
      </div>
    </div>
