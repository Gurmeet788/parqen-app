...
function Avatar({ user, size = 40, radius = "rounded-full" }) {
  ...
  return (
    <div
      className={`flex-shrink-0 flex items-center justify-center font-black text-white ${radius}`}
      style={{
        width: size,
        height: size,
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              >
                <ThumbsUp
                  size={22}
                  fill={isPositive === true ? "currentColor" : "none"}
                />
              </div>
              <span
            ...
            >
              ...
              >
                <ThumbsDown
                  size={22}
                  fill={isPositive === false ? "currentColor" : "none"}
                />
              </div>
              <span
                className={`font-black text-xs uppercase tracking-wide ${
...
function ConfirmActionModal({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-[360px] max-h-[90vh] overflow-y-auto"
        style={{
          backgroundColor: "#fff",
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              <Lock size={14} />
              Escrow BTC returns to the seller
            </p>
          </div>
        </div>
        ...
        <div style={{ padding: "16px 20px 20px" }}>
          ...
          >
            <FileText size={15} />
            Reason for cancelling <span style={{ color: C.danger }}>*</span>
          </p>
          <textarea
            value={reason}
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                cursor:
                  reason.trim() && !submitting ? "pointer" : "not-allowed",
    ...
    >
      ...
      >
        ...
        >
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <h3 className="font-black text-sm" style={{ color: "#991B1B" }}>
                Report to Moderator
              </h3>
            </div>
            <p className="text-xs" style={{ color: "#B91C1C" }}>
              A PRAQEN moderator will review your case within{" "}
              <strong>24 hours</strong>. All chats are logged.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 space-y-2">
          <p className="text-xs font-black mb-3" style={{ color: "#334155" }}>
            What is the problem?
          </p>
          {DISPUTE_REASONS.map((r) => (
            ...
            >
              <span className="mr-2 text-sm">{selected === r ? "◉" : "○"}</span>
              {r}
            </button>
          ))}
        </div>
          ...
          <div className="px-5 pb-4">
            <p className="text-xs font-bold mb-2" style={{ color: "#334155" }}>
              {isOther
                ...
                : "Additional details for the moderator (optional):"}
            </p>
            <textarea
              value={details}
              ...
              placeholder={
                isOther
                  ...
                  : "Any extra context to help the moderator resolve faster…"
              }
              rows={3}
        ...
        <div className="px-5 pb-5 flex gap-3">
          ...
          <button
            onClick={() => canSubmit && !submitting && onSubmit(fullReason)}
            disabled={!canSubmit || submitting}
            className="flex-1 py-3 rounded-2xl text-xs font-black transition"
            style={{
              backgroundColor: canSubmit ? "#DC2626" : "#E2E8F0",
...
function ProfilePopup({ user, label, trade, onClose }) {
  ...
  useEffect(() => {
    ...
    setRvLoad(true);
    axios
      .get(`${API_URL}/users/${user.id}/reviews`)
  ...
  const total = pos + neg;
  const trust =
    total > 0 ? Math.round((pos / total) * 100) : trades > 0 ? 100 : 0;
  ...
  const avgPayDisplay =
    payMins > 0
      ? (() => {
          const m = Math.floor(payMins),
            s = Math.round((payMins - m) * 60);
          return s > 0 ? `${m}m ${s}s` : m > 0 ? `${m}m` : `${s}s`;
        })()
      : "—";
  ...
  const countryName =
    u.country && u.country.length > 2
      ? u.country
      : CC_NAME[locCC] || u.location || locCC || "—";
  ...
  const verifications = [
    { label: "Phone Number", ok: phoneOk, icon: Smartphone },
    { label: "Email Address", ok: emailOk, icon: Mail },
    { label: "ID / KYC", ok: kycOk, icon: BadgeCheck },
  ];
  ...
  const tradeOpened = trade?.created_at
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full sm:max-w-sm rounded-t-3xl sm:rounded-2xl shadow-2xl flex flex-col"
        style={{
          maxHeight: "92dvh",
      ...
      >
        ...
        {/* ── HEADER ── */}
        <div
          className="relative px-4 pt-3 pb-4 flex-shrink-0"
          style={{
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1.5 flex-wrap mb-1.5">
                ...
                <span className="text-white/60 text-xs">
                  {isOnline ? "🟢 Active now" : rawSeen}
                </span>
              </div>
              <span
                className="inline-flex items-center gap-px px-2 py-0.5 rounded-full border text-xs font-black"
                style={{
                  background: badge.bg,
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              <div
                ...
                style={{ backgroundColor: isOnline ? "#4ADE80" : "#94A3B8" }}
              />
            ...
            >
              <Heart
                size={14}
                style={{
                  color: pos > 0 ? "#86EFAC" : "rgba(255,255,255,0.5)",
                  flexShrink: 0,
                }}
              />
              <div className="min-w-0">
                <p className="text-white font-black text-xs leading-tight">
                  {pos > 0 ? `${fmt(pos)} users` : "No ratings yet"}
                </p>
                <p className="text-white/50 text-xs leading-tight">
                  Trusted by
                </p>
        ...
        >
          {TABS.map(({ id, label }) => (
            <button
              key={id}
              onClick={() => setTab(id)}
              className="flex items-center gap-2 flex-shrink-0 px-3 py-2.5 text-xs font-bold whitespace-nowrap transition"
              style={{
                color: tab === id ? C.green : C.g500,
                borderBottom:
                  tab === id ? `2px solid ${C.green}` : "2px solid transparent",
        ...
        >
          ...
          {tab === "overview" && (
            <div className="space-y-3">
              ...
              >
                <p
                  className="text-xs font-black px-3 py-2 uppercase tracking-wider"
                  style={{ color: C.g500, backgroundColor: C.g50 }}
                >
                  Verification
                </p>

                {verifications.map(({ label, ok, icon: Icon }) => (
                  <div
                    key={label}
              ...
              {rvLoad ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-xs mt-1" style={{ color: C.g400 }}>
                    Complete trades to earn reviews
                  </p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className="text-xs font-black"
                            style={{ color: isPos ? "#166534" : "#991B1B" }}
                          >
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <p className="text-xs font-bold" style={{ color: "#92400E" }}>
                  Time limit: {listing?.time_limit || 30} minutes — trade
                  auto-cancels if unpaid
                </p>
              </div>
              <div
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "#991B1B" }}
                >
                  <strong>Never release BTC</strong> before confirming payment
                  is received in your account. Escrow protects every trade.
                </p>
              </div>
            </div>
          )}
            ...
            >
              {[
                ...
                { label: "Status", value: tradeStatus },
                {
                  ...
                  value:
                    listing?.payment_method || trade?.payment_method || "—",
                },
                {
                  label: "Fiat Amount",
                  value: tradeAmt ? `${sym}${fmt(tradeAmt)} ${cur}` : "—",
                },
                {
                  label: "BTC Amount",
                  value: tradeBtc ? `${fmtBtc(tradeBtc, 6)} BTC` : "—",
                },
                {
                  label: "Time Limit",
                  value: `${listing?.time_limit || 30} minutes`,
                },
                ...
                <div
                  key={lbl}
                  className="flex items-center justify-between px-3.5 py-3 border-b last:border-0"
                  style={{ borderColor: C.g100 }}
                >
                  <span
                    className="text-xs font-semibold"
                  ...
                  <span
                    className="text-xs font-black text-right ml-4"
                    style={{ color: C.g800, maxWidth: "60%" }}
                  >
                    {value}
                  </span>
                </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs font-bold flex-1" style={{ color: C.g700 }}>
          Trade Instructions
        </span>
        {open ? (
          <ChevronUp size={12} style={{ color: C.g400 }} />
        ) : (
      ...
      {open && (
        <div
          className="border-t px-3 pb-3 pt-2 text-xs leading-relaxed whitespace-pre-wrap"
...
export default function TradeDetail({ user }) {
  ...
  const tradeAge = trade?.created_at
    ? (() => {
        const diff = Math.floor(
          (Date.now() - new Date(trade.created_at)) / 1000,
        );
  ...
  useEffect(() => {
    ...
    const sendHb = () =>
      axios
        .post(`${API_URL}/users/heartbeat`, {}, { headers: authH() })
        .catch(() => {});
    sendHb();
  ...
  useEffect(() => {
    ...
    const deadline = trade.expires_at
      ...
      : toUTC(trade.created_at).getTime() +
        Math.max(trade?.listing?.time_limit || 0, trade?.time_limit || 0, 30) *
          60 *
          1000;
  ...
  const loadTrade = async () => {
    ...
    try {
      setLoadErr(false);
      const r = await axios.get(`${API_URL}/trades/${id}`, {
        headers: authH(),
        timeout: 15000,
      });
      ...
      console.error(
        "[TradeDetail] loadTrade error — status:",
        status,
        "msg:",
        e.message,
      );
  ...
  const loadImages = async () => {
    if (!id) return;
    try {
      const r = await axios.get(`${API_URL}/trades/${id}/images`, {
        headers: authH(),
      });
  ...
  const fetchTyping = async () => {
    if (!id) return;
    try {
      const r = await axios.get(`${API_URL}/trades/${id}/typing`, {
        headers: authH(),
      });
      setCpTyping(!!r.data.isTyping);
    } catch {}
  };
  ...
  const sendTypingPing = () => {
    ...
    axios
      .post(`${API_URL}/trades/${id}/typing`, {}, { headers: authH() })
      .catch(() => {});
  ...
  const postSys = async (text) => {
    try {
      await axios.post(
        `${API_URL}/messages`,
        { tradeId: id, message: text, isSystem: true },
        { headers: authH() },
      );
      await loadMessages();
    } catch {}
  ...
  const uploadImage = async (file) => {
    ...
    try {
      ...
      await axios.post(
        `${API_URL}/trades/${id}/upload-image`,
        { image: b64, type: isBuyer ? "payment" : "giftcard" },
        { headers: authH() },
      );
      // Send as a real chat message so both users see the image inline
      await axios.post(
        `${API_URL}/messages`,
        { tradeId: id, message: b64 },
        { headers: authH() },
      );
  ...
  const markPaid = async () => {
    ...
    try {
      await axios.post(
        `${API_URL}/trades/${id}/mark-paid`,
        {},
        { headers: authH() },
      );
      toast.success(
        isGiftCardTrade
          ? "Code sent! Waiting for buyer to verify."
          : "Payment confirmed!",
      );
      await loadTrade();
    } catch (e) {
  ...
  const releaseBtc = async () => {
    if (!actionCode2FA || actionCode2FA.length !== 6) {
    ...
    try {
      await axios.post(
        `${API_URL}/trades/${id}/release`,
        { actionCode: actionCode2FA },
        { headers: authH() },
      );
      setActionCode2FA("");
      await postSys(
        "🎉 TRADE COMPLETE! Bitcoin has been released to the buyer. Congratulations to both parties — always come back and trade safely on PRAQEN! 🙌",
      );
  ...
  const cancelTrade = async (reason) => {
    ...
    try {
      await axios.post(
        `${API_URL}/trades/${id}/cancel`,
        { reason },
        { headers: authH() },
      );
      await postSys(
        `❌ Trade cancelled. Reason: ${reason}. Escrow funds returned.`,
      );
      ...
      toast.error(
        e?.response?.data?.error || "Failed to cancel trade. Please try again.",
      );
    } finally {
      setSubmitting(false);
    }
  ...
  const autoCancel = async () => {
    ...
    try {
      const { data: fresh } = await axios.get(`${API_URL}/trades/${id}`, {
        headers: authH(),
      });
      const freshStatus = (
        fresh?.trade?.status ||
      ...
      if (
        ["PAYMENT_SENT", "PAID", "COMPLETED", "CANCELLED", "DISPUTED"].includes(
          freshStatus,
        )
      ) {
    ...
    try {
      await axios.post(
        `${API_URL}/trades/${id}/auto-cancel`,
        { reason: "Payment window expired" },
        { headers: authH() },
      );
      await postSys(
        "Payment window closed. Trade cancelled and Bitcoin returned to seller's wallet.",
      );
  ...
  const submitDispute = async (reason) => {
    ...
    try {
      await axios.post(
        `${API_URL}/trades/${id}/dispute`,
        { reason },
        { headers: authH() },
      );
      toast.warning(
        "Dispute reported. A moderator will review within 24 hours.",
      );
  ...
  const submitFeedback = async (rating, comment) => {
    ...
    try {
      await axios.post(
        `${API_URL}/trades/${id}/feedback`,
        {
          rating,
          comment,
          toUserId: isBuyer ? trade.seller_id : trade.buyer_id,
        },
        { headers: authH() },
      );
        ...
        <div className="text-center space-y-4 p-8 bg-white rounded-2xl shadow-lg max-w-md">
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="px-6 py-2.5 rounded-xl font-bold text-sm border-2"
  ...
  const sym =
    CUR_SYM[cur] ||
    trade.currency_symbol ||
    trade.listing?.currency_symbol ||
    "₵";

  // VERIFIED FORMULAS
  const userPays = parseFloat(
    trade.amount_local ||
      parseFloat(trade.amount_usd || 0) * (USD_RATES[cur] || 1) ||
      0,
  );
  ...
  const btcValueInLocal =
    margin !== 0 ? userPays / (1 + margin / 100) : userPays;
  ...
  const sellerRate = parseFloat(
    trade.seller_rate_local ||
      trade.seller_rate ||
      (btcGross > 0 ? userPays / btcGross : 0),
  );
  ...
  const cpFeedbackPct =
    cpPos + cpNeg > 0
      ? ((cpPos / (cpPos + cpNeg)) * 100).toFixed(1)
      : parseFloat(cp?.completion_rate || 100).toFixed(1);
  ...
  const showMarkPaid = isGiftCardTrade
    ? isSeller && isEscrow && isActive
    : isBuyer && isEscrow && isActive;
  const showRelease = isGiftCardTrade
    ? isBuyer && isPaid && isActive
    : isSeller && isPaid && isActive;
  ...
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-12 gap-3 lg:[height:calc(100vh-56px)]">
          ...
          <div className="order-2 lg:order-1 lg:col-span-4 space-y-3 lg:overflow-y-auto pb-3 lg:[max-height:calc(100vh-56px)]">
            ...
            >
              ...
              <div className="space-y-2.5">
                {(isGiftCardTrade
                  ? [
                      {
                        label: "Trade opened — Alice's BTC locked in escrow",
                        done: true,
                      },
                      {
                        label: "Card seller sends gift card code to buyer",
                        done: isPaid || isCompleted,
                      },
                      {
                        label: "Buyer verifies the code is valid",
                        done: isCompleted,
                      },
                      {
                        label: "Buyer releases BTC to card seller (0.5% fee)",
                        done: isCompleted,
                      },
                    ]
                  : [
                      {
                        label: "Trade opened — BTC locked in escrow",
                        done: true,
                      },
                      {
                        label: `Buyer sends payment via ${payMethod}`,
                        done: isPaid || isCompleted,
                      },
                      {
                        label: "Seller confirms payment received",
                        done: isPaid || isCompleted,
                      },
                      {
                        label: "Bitcoin released to buyer (0.5% fee deducted)",
                        done: isCompleted,
                      },
                    ]
                ).map(({ label, done }, i) => (
            ...
            <div className="space-y-2">
                  ...
                  {isGiftCardTrade ? (
                    isSeller ? (
                      <>
                        ...
                        <span>
                          Your turn: Send your gift card code to the buyer in
                          the chat, then click{" "}
                          <strong>"I SENT THE CODE"</strong>.
                        </span>
                      </>
                    ) : (
                      <>
                        ...
                        <span>
                          Waiting for the card seller to send you the gift card
                          code…
                        </span>
                      </>
                    )
                    ...
                    <>
                      ...
                      <span>
                        Your turn: Send {payMethod} payment now, then click{" "}
                        <strong>"I HAVE PAID"</strong> to notify the seller.
                      </span>
                    </>
                  ) : (
                    <>
                      <Clock3 size={16} className="mt-0.5 flex-shrink-0" />
                      <span>Waiting for the buyer to send payment…</span>
                    </>
                  )}
                </div>
              )}
                ...
                >
                  {isBuyer ? (
                    <>
                      ...
                      />
                      <span>
                        Code received! Test it — if it works, click{" "}
                        <strong>RELEASE BITCOIN</strong> to pay the seller.
                      </span>
                    </>
                  ) : (
                    <>
                      <Clock3 size={16} className="mt-0.5 flex-shrink-0" />
                      <span>
                        Buyer is verifying your gift card code. Bitcoin releases
                        once they confirm.
                      </span>
                    </>
                  )}
              ...
              {showRelease && (
                <button
                  onClick={() => setShowRelConfirm(true)}
                  disabled={submitting}
              ...
              {isCompleted && (
                <div
                  className="py-4 px-5 rounded-xl text-center text-white shadow"
                  style={{
                    background: `linear-gradient(135deg,${C.forest},${C.mint})`,
                  }}
                >
                  ...
                  <p className="text-xs text-white/60 mt-0.5">
                    0.5% fee auto-collected by escrow
                  </p>
                  {!trade?.user_gave_feedback &&
                    !localStorage.getItem("fb_done_" + id) && (
                      <button
              ...
              {isCancelled && (
                <div
                  className="py-3 px-5 rounded-xl text-center border"
                  style={{ backgroundColor: C.g100, borderColor: C.g200 }}
                >
                  <X
                    size={20}
              ...
              {isDisputed && (
                <div
                  className="py-3 px-5 rounded-xl text-center text-white"
                  style={{
                ...
                >
                  ...
                  <p className="text-xs text-white/70 mt-0.5">
                    PRAQEN Moderator reviewing within 24h
                  </p>
                </div>
              )}
            </div>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      borderBottom: infoOpen ? `1px solid ${C.g100}` : "none",
                    }}
                  >
                    <Info size={13} style={{ color: C.green }} />
                    <span
                      className="text-xs font-black flex-1 text-left"
                      style={{ color: C.forest }}
                    >
                      Trade Info & Actions
                    </span>
                    ...
                    {infoOpen ? (
                      <ChevronUp size={13} style={{ color: C.g400 }} />
                    ) : (
                        ...
                        <button
                          onClick={() => {
                            ...
                            const sub = encodeURIComponent(
                              `Trade Report: #${shortId}`,
                            );
                            const body = encodeURIComponent(
                              `Trade ID: ${trade.id}\nOffer: ${trade.listing_id || "—"}\nProblem: ${reason}\nUser: ${user?.username || "—"}`,
                            );
                            window.open(
                              `mailto:hello@praqen.com?subject=${sub}&body=${body}`,
                              "_blank",
                            );
            ...
            {/* Escrow info */}
            <div
              className="bg-white rounded-2xl border p-4 space-y-1.5"
              style={{ borderColor: C.g200 }}
            >
              ...
              {[
                { icon: Lock, text: "BTC locked in escrow when trade opens" },
                { icon: Wallet, text: "Buyer pays via agreed payment method" },
                {
                  icon: CheckCircle2,
                  text: "Seller confirms → releases BTC to buyer",
                },
                {
                  icon: Coins,
                  text: "0.5% fee auto-deducted to PRAQEN wallet",
                },
                {
                  icon: Siren,
                  text: "Open dispute if problem — resolved in 24h",
                },
              ].map(({ icon: Icon, text }) => (
                <p
                  key={text}
              ...
              {trade?.trade_ref && (
                ...
                >
                  ...
                  >
                    <span
                      className="font-mono font-black text-sm flex-1"
                      style={{ color: C.forest, letterSpacing: "0.05em" }}
                    >
                      {trade.trade_ref}
                    </span>
                    <button
                      onClick={() => {
                        navigator.clipboard.writeText(trade.trade_ref);
                  ...
                  <p className="text-xs mt-1" style={{ color: C.g400 }}>
                    Share this ID with support if you have issues
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="order-1 lg:order-2 lg:col-span-8 flex flex-col min-h-[55vh] lg:min-h-0 lg:[max-height:calc(100vh-56px)]">
            <div
              className="bg-white rounded-2xl border shadow-sm overflow-hidden flex flex-col flex-1"
              style={{ borderColor: C.g200 }}
            >
              {/* ── TRADE HEADER ─────────────────────────────────── */}
              <div
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 px-3 pt-2 pb-2">
                  <button
                    onClick={() => {
                      setProfUser(cp);
                      setProfLabel(isBuyer ? "Seller" : "Buyer");
                    }}
                  ...
                  >
                    <div className="relative flex-shrink-0">
                      ...
                      <div
                        ...
                        style={{
                          borderColor: T.dark,
                          backgroundColor: cpOnline ? C.online : C.g400,
                        }}
                      />
                    </div>
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        {cp?.kyc_verified && (
                          <BadgeCheck size={11} style={{ color: "#93C5FD" }} />
                        )}
                        <span
                          className={`inline-flex items-center gap-0.5 text-xs font-black px-1.5 py-0.5 rounded-full border ${cpBadge.animate ? "shadow-md" : ""}`}
                          style={{
                            background: cpBadge.bg,
                            borderColor: cpBadge.borderColor,
                            boxShadow: cpBadge.glow
                              ? `0 0 8px ${cpBadge.glow}`
                              : undefined,
                          }}
                        >
                          <span
                            style={{
                              color: cpBadge.iconColor || cpBadge.textColor,
                            }}
                          >
                            <Icon size={16} color={cpBadge.color} />
                          </span>
                          <span style={{ color: cpBadge.textColor }}>
                            {cpBadge.label}
                          </span>
                        </span>
                      </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-2">
                    <div>
                      <p className="flex items-center gap-1 text-white/60 font-semibold mb-0.5 text-xs">
                        {isSellFlow ? (
                          <>
                            <Bitcoin size={14} />
                            You Send
                      ...
                      <p
                        ...
                        style={{ color: isSellFlow ? C.gold : "#fff" }}
                      >
                        {isSellFlow
                          ? `₿ ${btcReceived.toFixed(8)}`
                          : `${sym}${fmt(userPays, 0)}`}
                      </p>

                      <p className="text-white/60 font-semibold mt-0.5 text-xs">
                        {isSellFlow ? "Bitcoin" : `${cur} · ${payMethod}`}
                      </p>
                    </div>

                    <div className="text-right">
                      <p className="flex items-center justify-end gap-1 text-white/60 font-semibold mb-0.5 text-xs">
                        {isSellFlow ? (
                          <>
                            <Wallet size={14} />
                            You Receive
                  ...
                  <div className="flex items-center justify-between border-t border-white/10 pt-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      >
                        {sym}
                        {fmt(sellerRate, 0)} {cur}/BTC
                      </span>
                      <span
                        className="font-black px-1.5 py-0.5 rounded-full"
                        style={{
                          backgroundColor: "rgba(244,164,34,0.2)",
                          color: C.gold,
                          fontSize: "10px",
                        }}
                      >
                ...
                {isActive && isPaid && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {isSellFlow
                          ? "Verify payment in your account, then release Bitcoin"
                          : "Awaiting seller to release Bitcoin"}
                      </span>
                    </div>
                  </div>
                )}
              ...
              {isDisputed && (
                <div
                  className="px-4 py-2 border-b flex-shrink-0 flex items-center justify-center gap-2"
                ...
                >
                  ...
                  <span
                    ...
                    style={{ color: "#6D28D9" }}
                  >
                    Dispute active — Moderator reviewing within 24h
                  </span>
                </div>
              )}
              ...
              >
                <div className="flex items-start gap-2">
                  <Shield
                    size={11}
                    style={{ color: "#166534", flexShrink: 0, marginTop: 2 }}
                  />
                  <p
                  ...
                  >
                    ...
                    <span>
                      {isBuyer ? (
                        <>
                          <strong>You are BUYING.</strong> Send payment via{" "}
                          <span className="font-black">{payMethod}</span>, then
                          tap{" "}
                          <span className="inline-flex items-center gap-1 font-black">
                            <CheckCircle2 size={14} />I HAVE PAID
                          </span>
                          . Only release after the seller confirms.
                        </>
                      ) : isSeller ? (
                        <>
                          <strong>You are SELLING.</strong> Wait for the buyer
                          to pay via{" "}
                          <span className="font-black">{payMethod}</span>. Once
                          payment arrives, tap{" "}
                          <span className="inline-flex items-center gap-1 font-black">
                            <CheckCircle2 size={14} />
                            RELEASE BITCOIN
              ...
              <div
                ...
                style={{ backgroundColor: "#F9FAFB", minHeight: 0 }}
              >
                {/* Proof images */}
                {images.length > 0 && (
                ...
                {messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <p className="text-xs" style={{ color: C.g300 }}>
                  ...
                  messages.map((m, i) => {
                    ...
                    if (isSys) {
                      const isSuccess =
                        /complet|released|btc.*released|verified|unlock/i.test(
                          text,
                        );
                      const isDanger = /cancel|expired|refund|failed/i.test(
                        text,
                      );
                      const isWarn =
                        /warning|urgent|expir|time.*left|5 minute/i.test(text);
                      const isPmt =
                        /⏳.*payment|payment.*sent|buyer.*paid|mark.*paid|sent.*payment|confirmed payment|payment.*confirm|payment confirmed/i.test(
                          text,
                        );
                      const isOpen =
                        /trade.*open|escrow.*lock|btc.*locked|opened/i.test(
                          text,
                        );
                      const isDisp = /disput|moderator|support.*review/i.test(
                        text,
                      );
                      ...
                      if (isPmt)
                        return (
                          <div
                            key={i}
                            className="flex justify-center my-4 px-1"
                          >
                            <div
                              className="w-full max-w-[95%] rounded-2xl overflow-hidden"
                              style={{
                                background:
                                  "linear-gradient(145deg,#1E3A5F,#1D4ED8,#2563EB)",
                                boxShadow:
                                  "0 0 0 2px #93C5FD, 0 8px 32px rgba(37,99,235,0.55)",
                            ...
                            >
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="font-black text-white text-xs tracking-[0.15em] uppercase">
                                    Payment Confirmed
                                  </span>
                                </div>
                                <span
                              ...
                              >
                                ...
                                <div
                                  className="mt-2.5 px-3 py-2 rounded-xl text-xs font-black flex items-center gap-2"
                                  style={{
                                    background: isSeller
                                      ? "rgba(37,99,235,0.10)"
                                      : "rgba(37,99,235,0.06)",
                                ...
                                >
                                  {isBuyer ? (
                                    <>
                                      ...
                                      />
                                      <span>
                                        You marked payment sent. Awaiting seller
                                        confirmation.
                                      </span>
                                    </>
                                  ) : isSeller ? (
                                    <>
                                      ...
                                      />
                                      <span>
                                        ACTION REQUIRED — Check your account
                                        now, then release Bitcoin.
                                      </span>
                                    </>
                                  ) : (
                                    <>
                                      <Wallet
                                        ...
                                        className="flex-shrink-0"
                                      />
                                      <span>Payment step confirmed.</span>
                                    </>
                                  )}
                                </div>
                              </div>
                        ...
                        return (
                          ...
                          >
                            <div
                              ...
                              style={{
                                background:
                                  "linear-gradient(145deg,#052e16,#065F46,#059669)",
                                boxShadow:
                                  "0 0 0 2px #6EE7B7, 0 8px 32px rgba(5,150,105,0.55)",
                              }}
                            >
                              <div
                                className="flex items-center justify-between px-4 py-2.5"
                              ...
                              <div className="px-4 py-3">
                                ...
                                <div
                                  className="mt-2.5 px-3 py-2 rounded-xl text-xs font-black"
                                  style={{
                                ...
                                >
                                  Bitcoin has left escrow. Leave feedback to
                                  help the community!
                                </div>
                              </div>
                            </div>
                      ...
                      if (isDisp) {
                        ...
                        grad = "linear-gradient(135deg,#450a0a,#991B1B)";
                        iconBg = "#FEE2E2";
                        Icon = CircleX;
                        label = "CANCELLED";
                      } else if (isWarn) {
                        ...
                        grad = "linear-gradient(135deg,#0c1a10,#1B4332)";
                        iconBg = "#D1FAE5";
                        Icon = ShieldCheck;
                        label = "TRADE OPEN";
                      } else {
                        ...
                        <div key={i} className="flex justify-center my-3 px-1">
                          <div className="w-full max-w-[95%] rounded-2xl overflow-hidden shadow-lg">
                            ...
                            >
                              ...
                              <span
                                className="text-xs font-black tracking-widest flex-1"
                                style={{
                    ...
                    if (isMod)
                      return (
                        <div key={i} className="flex justify-center my-3 px-1">
                          <div
                            className="w-full max-w-[95%] rounded-2xl overflow-hidden shadow-xl"
                          ...
                          >
                            ...
                            >
                              ...
                              <p
                                className="text-xs mt-2 text-right font-semibold"
                                style={{ color: "#7C3AED" }}
                              >
                                {ts}
                              </p>
                      ...
                      >
                        ...
                        >
                          ...
                          {isImage ? (
                              ...
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  e.currentTarget.parentElement.innerHTML =
                                    '<span style="padding:8px;font-size:12px;color:#94A3B8">Image unavailable</span>';
                                }}
                              />
                              <p
                                className="text-center text-xs py-1.5 font-bold"
                                style={{
                            ...
                            <div
                              className="px-3.5 py-2.5 text-sm font-medium break-words shadow-md"
                              style={{
                                background: isOwn ? ownBg : otherBg,
                                color: "#fff",
                                fontWeight: 500,
                          ...
                          <div
                            className={`flex items-center gap-1 mt-1 ${isOwn ? "justify-end" : "ml-1"}`}
                          >
                            <span className="text-xs" style={{ color: C.g400 }}>
                              {ts}
                            </span>
                        ...
                        {isOwn && (
                          <div
                            className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-black flex-shrink-0 shadow-md"
                ...
                {cpTyping && (
                  <div className="flex justify-start">
                    <div
                      className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-black mr-2 flex-shrink-0"
                      style={{ backgroundColor: C.mint, color: C.white }}
                    >
                      {cp?.username?.charAt(0)?.toUpperCase() || "?"}
                    </div>
                    <div
                      className="px-4 py-3 rounded-2xl rounded-tl shadow-sm flex items-center gap-1"
                      style={{
                        backgroundColor: "#fff",
                        border: `1px solid ${C.g200}`,
                      }}
                ...
                {isCompleted && (
                  <div
                    className="mx-1 my-2 rounded-xl overflow-hidden shadow-md"
                    style={{
                      background: `linear-gradient(135deg,${C.forest},${C.mint})`,
                    }}
                  >
                    <div className="px-4 py-3 text-center">
                      ...
                      <p
                        className="text-xs font-bold mt-0.5 mb-2"
                        style={{ color: "rgba(255,255,255,0.8)" }}
                      >
                        You just {isBuyer ? "bought" : "sold"} Bitcoin
                        successfully!
                      </p>
                      <p
                      ...
                      >
                        Always come back &amp; trade more — PRAQEN's safe escrow
              ...
              {isActive && isPaid && (
                <div
                  className="flex-shrink-0 mx-3 mb-2 rounded-xl overflow-hidden"
                  style={{
                    border: "2px solid #2563EB",
                    boxShadow: "0 2px 12px rgba(37,99,235,0.20)",
                  }}
                >
                  {/* header */}
                  <div
                  ...
                  >
                    <span className="flex items-center">
                      {isBuyer ? <Clock3 size={16} /> : <Bell size={16} />}
                    </span>
                  ...
                  >
                    {isBuyer ? (
                      <p
                        ...
                        style={{ color: "#1E40AF" }}
                      >
                        Your payment has been sent successfully. The seller has
                        been notified and will check their account now. Once
                        they confirm receipt, your Bitcoin will be released to
                        you automatically.
                      </p>
                    ) : (
                      <>
                        <p
                          ...
                          style={{ color: "#1E40AF" }}
                        >
                          The buyer has confirmed payment. Please check your{" "}
                          {payMethod} account right now.
                        </p>
                        <p
                        ...
                        >
                          <span className="inline-flex items-center gap-1">
                            <CheckCircle2 size={14} />
                            <span>
                              Payment received? → Scroll up and tap{" "}
                              <strong>RELEASE BITCOIN</strong> to complete the
                              trade.
                            </span>
                          </span>
                          ...
                          <span className="inline-flex items-center gap-1 mt-1">
                            <XCircle size={14} />
                            <span>
                              Not received? → Open a dispute so a moderator can
                              help.
                            </span>
                          </span>
                        </p>
              ...
              {isActive ? (
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        borderColor: msg ? C.green : C.g200,
                        fontSize: 15,
                        color: C.g800,
                        backgroundColor: "#F8FAFC",
                      }}
                ...
                <div
                  className="border-t p-3 text-center text-sm font-bold flex items-center justify-center gap-2 flex-shrink-0"
                  style={{
                    borderColor: C.g100,
                    color: C.g400,
                  }}
                >
                  <span>
                    Chat closed — trade{" "}
                    {isCompleted ? "completed successfully" : "cancelled"}
                  </span>
      ...
      {(showMarkPaid || showRelease) && (
        <div
          className="lg:hidden fixed left-0 right-0 z-40 px-3 py-2.5"
          style={{
          ...
          lines={
            isGiftCardTrade
              ? [
                  {
                    icon: Gift,
                    text: "You are confirming you have sent the gift card code to the buyer in the chat.",
                  },
                  {
                    icon: TriangleAlert,
                    text: "Only confirm if you have already shared the code. This cannot be undone.",
                  },
                  {
                    icon: Lock,
                    text: "The buyer will verify the code before Bitcoin is released.",
                  },
                ]
              : [
                  {
                    icon: CreditCard,
                    text: `You are confirming you have sent the full payment via ${payMethod}.`,
                  },
                  {
                    icon: TriangleAlert,
                    text: "Only confirm if you have already completed the transfer. This cannot be undone.",
                  },
                  {
                    icon: Lock,
                    text: "The seller will verify payment before releasing Bitcoin to you.",
                  },
                ]
          }
          confirmLabel={
            isGiftCardTrade ? "Yes, I Sent the Code" : "Yes, I Have Paid"
          }
          confirmBg={C.gold}
      ...
      {showRelConfirm && (
        <ConfirmActionModal
          ...
          lines={[
            {
              icon: Check,
              text: "Only release Bitcoin AFTER you have confirmed the payment in your bank or mobile money account.",
            },
            {
              icon: TriangleAlert,
              text: "This action is PERMANENT and cannot be reversed. Bitcoin will leave escrow immediately.",
            },
            {
              icon: Lock,
              text: "A 0.5% fee will be automatically deducted by the escrow system.",
            },
            {
              icon: Shield,
              text: "A security code will be sent to your email to confirm this action.",
            },
          ]}
        ...
        >
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-black text-base" style={{ color: C.g800 }}>
            ...
            <p className="text-sm mb-4" style={{ color: C.g600 }}>
              Enter the 6-digit code sent to your email to release Bitcoin. Code
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={releaseBtc}
                disabled={actionCode2FA.length !== 6 || submitting}
