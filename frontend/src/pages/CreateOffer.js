...
const GC_BRANDS = [
  ...
  { name:'Marshalls',                  icon:'🛍️', color:'#00263E' },
  { name:'HomeGoods',                  icon:'🏠', color:'#00263E' },
  { name:'Costco',                     icon:'🛒', color:'#E31837' },
  { name:"Sam's Club",                 icon:'🛒', color:'#0067A0' },
  { name:"BJ's Wholesale Club",        icon:'🛒', color:'#CC0000' },
  { name:'REI',                        icon:'🏔️', color:'#004F2D' },
  { name:"Dick's Sporting Goods",      icon:'⚽', color:'#000000' },
  { name:'Academy Sports + Outdoors',  icon:'⚽', color:'#003DA5' },
  { name:'Bass Pro Shops',             icon:'🎣', color:'#8B4513' },
  { name:"Cabela's",                   icon:'🎣', color:'#004225' },
  { name:'Guitar Center',              icon:'🎸', color:'#000000' },
  { name:"Musician's Friend",          icon:'🎸', color:'#000000' },
  { name:'American Girl',              icon:'🎀', color:'#E4022D' },
  { name:'LEGO',                       icon:'🧱', color:'#D01012' },
  { name:'Build-A-Bear Workshop',      icon:'🧸', color:'#8B4B9C' },
  { name:'Pottery Barn',               icon:'🏺', color:'#2C2A29' },
  { name:'West Elm',                   icon:'🛋️', color:'#000000' },
  { name:'Crate & Barrel',             icon:'🍽️', color:'#000000' },
  { name:'Williams-Sonoma',            icon:'🍳', color:'#000000' },
  { name:'Sur La Table',               icon:'🍳', color:'#000000' },
  { name:'Zappos',                     icon:'👟', color:'#A0DE07' },
  { name:'6pm',                        icon:'👟', color:'#000000' },
  { name:'Nordstrom',                  icon:'👗', color:'#000000' },
  { name:"Bloomingdale's",             icon:'👗', color:'#000000' },
  { name:'Neiman Marcus',              icon:'👗', color:'#000000' },
  { name:'Saks Fifth Avenue',          icon:'👗', color:'#000000' },
  { name:'Barneys New York',           icon:'👗', color:'#000000' },
  { name:'Tiffany & Co.',              icon:'💍', color:'#0ABAB5' },
  { name:'Coach',                      icon:'👜', color:'#7A1F2B' },
  { name:'Michael Kors',               icon:'👜', color:'#000000' },
  { name:'Kate Spade',                 icon:'👜', color:'#00A99D' },
  { name:'Tory Burch',                 icon:'👜', color:'#000000' },
  { name:'Vera Bradley',               icon:'👜', color:'#762A83' },
  { name:'L.L.Bean',                   icon:'🥾', color:'#00543D' },
  { name:'Cuisinart',                  icon:'🍳', color:'#C8102E' },
  { name:'KitchenAid',                 icon:'🍳', color:'#000000' },
  { name:'Le Creuset',                 icon:'🍳', color:'#F26B21' },
  { name:'Anthropologie',              icon:'👗', color:'#000000' },
  { name:'Free People',                icon:'👗', color:'#000000' },
  { name:'Urban Outfitters',           icon:'👕', color:'#000000' },
  { name:'Madewell',                   icon:'👖', color:'#002F6C' },
  { name:"J.Crew",                     icon:'👕', color:'#002F6C' },
  { name:'Banana Republic',            icon:'👔', color:'#000000' },
  { name:'Gap',                        icon:'👕', color:'#002868' },
  { name:'Old Navy',                   icon:'👕', color:'#003057' },
  { name:'Athleta',                    icon:'🏃', color:'#000000' },
  { name:'Lululemon',                  icon:'🧘', color:'#000000' },
  { name:'SoulCycle',                  icon:'🚴', color:'#FFD100' },
  { name:'Peloton',                    icon:'🚴', color:'#000000' },
  ...
  { name:'Microsoft Office',           icon:'💻', color:'#D83B01' },
  { name:'Adobe Creative Cloud',       icon:'🎨', color:'#FF0000' },
  { name:'Autodesk',                   icon:'📐', color:'#0696D7' },
  { name:'SketchUp',                   icon:'📐', color:'#005F9E' },
  { name:'Minecraft',                  icon:'🟩', color:'#5C8A3A' },
  { name:'The Sims',                   icon:'🎮', color:'#00A651' },
  { name:'World of Warcraft',          icon:'🎮', color:'#000000' },
  { name:'Final Fantasy XIV',          icon:'🎮', color:'#1A1A2E' },
  { name:'Under Armour',               icon:'⚽', color:'#000000' },
  { name:'American Eagle',             icon:'👕', color:'#002868' },
  { name:'Abercrombie & Fitch',        icon:'👕', color:'#000000' },
  { name:'Hollister',                  icon:'👕', color:'#000080' },
  { name:"Victoria's Secret",          icon:'👙', color:'#000000' },
  { name:'Bath & Body Works',          icon:'🧴', color:'#000000' },
  { name:'Bed Bath & Beyond',          icon:'🏠', color:'#004B87' },
  { name:'TJ Maxx',                    icon:'🛍️', color:'#E4032E' },
  { name:'Starbucks',                  icon:'☕', color:'#00704A' },
  { name:'Wayfair',                    icon:'🛋️', color:'#7B2CBF' },
  { name:'CVS Pharmacy',               icon:'💊', color:'#CC0000' },
  { name:"Dillard's",                  icon:'👗', color:'#000000' },
