  ...
  return (
    ...
    >
      ...
      <div className="px-3 mb-4 max-w-2xl mx-auto w-full slide d2">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
          {[
            { label: "Active Trades", value: "2", icon: Zap, color: C.gold },
            { label: "Completed", value: "47", icon: Check, color: C.success },
            { label: "Volume", value: "₵125K", icon: Wallet, color: C.paid },
            { label: "Rating", value: "4.9", icon: Star, color: C.gold },
            ...
            >
              <div className="flex items-center justify-between mb-1">
                ...
                <p className="text-xs truncate ml-1" style={{ color: C.g400 }}>
                  {label}
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-xs font-black" style={{ color: C.g600 }}>
                Last Trade
              </p>
            </div>
            <p
        ...
        >
          {[
            ...
            <Link
              ...
              style={{
                borderBottom:
                  i < arr.length - 1 ? `1px solid ${C.g100}` : "none",
              }}
            >
              <div
              ...
              <ChevronRight
                size={14}
                style={{ color: C.g400, flexShrink: 0 }}
              />
            </Link>
          ))}
        </div>
      ...
      <div className="px-3 pb-2 max-w-2xl mx-auto text-center">
        <p className="text-xs font-black mb-1">
          ...
          <span
            className="ml-1.5 px-1.5 py-0.5 rounded-full font-black text-xs"
        ...
        <p className="text-xs" style={{ color: C.g400 }}>
          <a href="mailto:hello@praqen.com" style={{ color: C.green }}>
            hello@praqen.com
          </a>{" "}
