...
function Ticker() {
  ...
  return (
    <div
      className="flex items-center gap-2 px-3 py-2.5 rounded-2xl text-xs w-full"
      style={{
    ...
    >
      ...
      <div
        className="w-6 h-6 rounded-full flex items-center justify-center font-black text-xs text-white flex-shrink-0"
        style={{ background: C.green }}
      >
        {t.user[0]}
      </div>
      <span className="font-black text-white truncate flex-1 min-w-0">
        {t.user}
      </span>
      <span
        className="hidden sm:inline truncate flex-shrink-0"
        style={{ color: "rgba(255,255,255,0.45)" }}
      >
      ...
      <span
        ...
        style={{ color: t.type === "buy" ? C.gold : C.sage }}
      >
        {t.amount}
      </span>
    </div>
  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{
          background: `linear-gradient(145deg,${C.forest} 0%,#0c2418 50%,${C.green} 100%)`,
          minHeight: "100dvh",
          display: "flex",
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-6 pb-10 md:py-24 w-full">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-20 items-center">
            ...
            <div>
              {/* badge */}
              <div
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold mb-6 ${heroOn ? "anim-up" : ""}`}
                style={{
                  opacity: heroOn ? 1 : 0,
                  background: "rgba(244,164,34,.15)",
                  border: "1px solid rgba(244,164,34,.35)",
                  color: C.gold,
                }}
              >
                <span
              ...
              {/* headline */}
              <h1
                className={`text-[1.6rem] sm:text-5xl lg:text-6xl font-black leading-[1.1] mb-4 text-white ${heroOn ? "anim-up" : ""}`}
                style={{
                  opacity: heroOn ? 1 : 0,
              ...
              {/* sub */}
              <p
                className={`text-sm md:text-base mb-7 leading-relaxed max-w-lg ${heroOn ? "anim-up" : ""}`}
                style={{
                  opacity: heroOn ? 1 : 0,
              ...
              >
                Trade Bitcoin &amp; USDT directly with verified peers using
                WeChat Pay, M-Pesa, SEPA, UPI, Bank Transfer and 100+ local
                payment methods across 180+ countries. Every trade is
                escrow-protected.
              </p>

              {/* CTAs */}
              <div
                className={`flex flex-col sm:flex-row gap-3 mb-7 ${heroOn ? "anim-up" : ""}`}
                style={{ opacity: heroOn ? 1 : 0, animationDelay: ".26s" }}
              >
                {user ? (
                  <>
                    <button
                      onClick={() => goTo("/buy-bitcoin")}
                      ...
                      style={{
                        background: C.gold,
                        color: C.forest,
                        boxShadow: `0 4px 22px ${C.gold}50`,
                      }}
                    >
                      <Bitcoin size={18} /> Buy Bitcoin <ArrowRight size={16} />
                    </button>
                    <button
                      onClick={() => goTo("/sell-bitcoin")}
              ...
              {/* trust row */}
              <div
                className={`flex flex-wrap gap-2 mb-5 ${heroOn ? "anim-up" : ""}`}
                style={{ opacity: heroOn ? 1 : 0, animationDelay: ".34s" }}
              >
                {[
                  { icon: ShieldCheck, text: "Escrow" },
                  { icon: Zap, text: "15 min" },
                  { icon: BadgeDollarSign, text: "0.5%" },
                ...
                <span
                  className="text-xs px-2.5 py-1 rounded-full flex-shrink-0 flex items-center gap-1.5"
                  style={{
                    color: "#F6821F",
                ...
                >
                  <Shield size={13} fill="currentColor" strokeWidth={1.5} />
              ...
              {/* ticker */}
              <div
                className={heroOn ? "anim-fade" : ""}
                style={{ opacity: heroOn ? 1 : 0, animationDelay: ".42s" }}
              >
                <Ticker />
              </div>
            </div>
            ...
            {/* right — BTC card */}
            <div
              className={`hidden md:flex items-center justify-center ${heroOn ? "anim-fade" : ""}`}
              style={{ opacity: heroOn ? 1 : 0, animationDelay: ".3s" }}
            >
              <div className="relative">
                {/* main card */}
                <div
                  className="float bg-white rounded-3xl shadow-2xl overflow-hidden"
                ...
                >
                  ...
                  <div className="p-5 border-b" style={{ borderColor: C.g100 }}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        ...
                        style={{
                          background: up ? `${C.success}15` : `${C.danger}15`,
                  ...
                  <div className="p-4 space-y-2">
                    <div
                      ...
                      style={{ color: C.g400 }}
                    >
                      <BadgeCheck size={14} style={{ color: "#F97316" }} />
                    ...
                    ].map(({ n, m, icon: Icon, r, badge, bc, t }) => (
                      <div
                        key={n}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="flex items-center gap-1">
                              ...
                              <span
                                className="font-black text-white rounded-full px-1"
                                style={{
                                  background: bc,
                                  fontSize: 9,
                                }}
                  ...
                  <div className="px-4 pb-4">
                    <button
                      onClick={() => goTo(user ? "/buy-bitcoin" : "/register")}
                ...
                {/* floating badges */}
                <div
                  className="absolute -top-5 -right-10 bg-white rounded-2xl px-3 py-2 shadow-xl flex items-center gap-1.5 text-xs font-bold float2"
                  style={{
                    color: C.success,
                ...
                <div
                  className="absolute -bottom-5 -left-10 bg-white rounded-2xl px-3 py-2 shadow-xl flex items-center gap-1.5 text-xs font-bold float2"
                  style={{
                    color: C.paid,
                    border: `1px solid ${C.paid}25`,
                    animationDelay: "2s",
                  }}
                >
                ...
                <div
                  className="absolute top-1/3 -left-14 bg-white rounded-2xl px-3 py-2 shadow-xl flex items-center gap-1.5 text-xs font-bold float"
                  style={{
                    color: C.gold,
          ...
          <div className="max-w-5xl mx-auto px-4 py-5 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div key={l} className="text-center">
                <p className="text-xl md:text-3xl font-black grad-text mb-0.5">
                  {v}
                </p>
                <p
                  className="text-xs"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div
            className={`text-center mb-8 md:mb-12 ${productsOn ? "anim-up" : ""}`}
            style={{ opacity: productsOn ? 1 : 0 }}
          >
            ...
            <p className="text-base max-w-xl mx-auto" style={{ color: C.g500 }}>
              One platform. Everything you need to buy, sell and convert crypto
              — fast, safe and on your terms.
            </p>
          </div>
            ...
            {[
              ...
              (
                ...
                >
                  {featured && (
                    <div
                      className="absolute top-5 right-5 px-2.5 py-1 rounded-full text-xs font-black"
                  ...
                  <div
                    className="flex items-center gap-1 font-black text-sm pt-3 border-t"
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div
            className={`text-center mb-8 md:mb-14 ${howOn ? "anim-up" : ""}`}
            style={{ opacity: howOn ? 1 : 0 }}
          >
            ...
            {[
              {
                ...
                desc: "Sign up free in 30 seconds. Email verified. No bank account needed to get started.",
              },
              {
                n: "02",
                icon: Search,
                title: "Browse Offers",
                desc: "Filter by payment method, country, currency and rate. Thousands of verified sellers live.",
              },
              {
                n: "03",
                icon: ShieldCheck,
                title: "Escrow Locks BTC",
                desc: "The seller's Bitcoin is automatically secured in escrow before you make any payment.",
              },
              {
                n: "04",
                icon: CheckCircle,
                title: "Pay & Receive",
                desc: "Send your payment and confirm — Bitcoin lands in your wallet instantly. Trade complete!",
              },
            ].map(({ n, icon: Icon, title, desc }, i) => (
              <div
                key={n}
                className={`relative text-center ${howOn ? "anim-up" : ""}`}
                style={{
                  opacity: howOn ? 1 : 0,
                  animationDelay: `${i * 0.1}s`,
                }}
              >
                ...
                <div
                  className="relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-md"
                  style={{
                    background: `linear-gradient(135deg,#fff,${C.g50})`,
                ...
                <div
                  className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-black mx-auto mb-3"
                  style={{ background: C.gold, color: C.forest }}
                >
                  {n}
                </div>
          ...
          <div className="text-center mt-12">
            <button
              ...
              style={{
                background: C.green,
                color: "#fff",
                boxShadow: `0 4px 20px ${C.green}45`,
              }}
            >
              {user ? "Start Trading Now" : "Get Started Free"}{" "}
              <ArrowRight size={16} />
            </button>
          </div>
        </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div
            className={`text-center mb-8 md:mb-12 ${featOn ? "anim-up" : ""}`}
            style={{ opacity: featOn ? 1 : 0 }}
          >
            ...
            <p className="text-base max-w-xl mx-auto" style={{ color: C.g500 }}>
              Everything you need to trade safely, quickly and confidently — no
              compromises.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Bitcoin locks automatically the moment a trade starts. Released only when both parties confirm. Zero fraud possible.",
                color: C.green,
              },
              {
                icon: Globe,
                title: "100+ Payment Methods",
                desc: "WeChat Pay, Alipay, M-Pesa, MTN MoMo, SEPA, UPI, PayPal, Revolut, Bank Transfer and more — local and global, all in one place.",
                color: C.paid,
              },
              {
                icon: Zap,
                title: "Trades Under 15 Minutes",
                desc: "No intermediaries. No complicated requirements. Match with a trader and complete your transaction in minutes.",
                color: C.gold,
              },
              {
                icon: MessageCircle,
                title: "Fast Dispute Resolution",
                desc: "Our neutral team reviews both sides and resolves every dispute within 24 hours. Your funds stay safe throughout.",
                color: C.success,
              },
              {
                icon: HeadphonesIcon,
                title: "24/7 Human Support",
                desc: "Real people. Real solutions. Our global team is always online via in-app chat, WhatsApp and Discord — any time.",
                color: C.purple,
              },
              {
                icon: Lock,
                title: "Zero Hidden Fees",
                desc: "Flat 0.5% fee on completed trades only. No listing fees, no withdrawal fees, no monthly plans. Pay only when you win.",
                color: C.danger,
              },
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* left */}
            <div
              className={escrowOn ? "anim-up" : ""}
              style={{ opacity: escrowOn ? 1 : 0 }}
            >
              ...
              <p
                ...
                style={{ color: C.g500 }}
              >
                Every PRAQEN trade is protected by our escrow system. Bitcoin is
                locked the moment a trade starts. No seller can run away with
                your money. No buyer can claim they paid without proof. You're
              ...
              <div className="space-y-4">
                {[
                  {
                    icon: Lock,
                    title: "BTC Locks Automatically",
                    desc: "Seller's BTC is locked in escrow the instant a trade opens. Zero manual steps needed.",
                    color: C.green,
                  },
                  {
                    icon: Shield,
                    title: "Both Parties Protected",
                    desc: "Buyer pays, seller confirms receipt. Neither side can cheat — every step is verified.",
                    color: C.paid,
                  },
                  {
                    icon: CheckCircle,
                    title: "Instant & Guaranteed",
                    desc: "Once confirmed by both sides, BTC is released instantly to the buyer. Safe every time.",
                    color: C.success,
                  },
            ...
            {/* right — flow diagram */}
            <div
              className={`${escrowOn ? "anim-up" : ""} float`}
              style={{ opacity: escrowOn ? 1 : 0, animationDelay: ".2s" }}
            >
              <div
                className="rounded-3xl p-6 border"
                style={{ background: C.g50, borderColor: C.g200 }}
              >
                <p
                  className="text-xs font-black uppercase tracking-widest mb-5 text-center"
                  style={{ color: C.mint }}
                >
                ...
                <div className="space-y-3">
                  {[
                    {
                      from: "Buyer",
                      action: "Opens trade & locks funds in view",
                      to: "Escrow",
                      icon: CreditCard,
                      color: C.paid,
                    },
                    {
                      from: "Seller",
                      action: "BTC locked automatically",
                      to: "Escrow",
                      icon: ShieldCheck,
                      color: C.forest,
                    },
                    ...
                    {
                      from: "Seller",
                      action: "Confirms payment received",
                      to: "Escrow",
                      icon: CheckCircle,
                      color: C.success,
                    },
                    {
                      from: "Escrow",
                      action: "Releases BTC to buyer instantly",
                      to: "Buyer",
                      icon: Zap,
                      color: C.green,
                    },
                  ].map(({ from, action, to, icon: Icon, color }, i) => (
                    <div
                      key={i}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 text-xs">
                          ...
                          <span className="font-bold" style={{ color: C.g600 }}>
                            {to}
                          </span>
                        </div>
                ...
                <div
                  className="mt-4 p-3 rounded-2xl flex items-center justify-center gap-2 text-xs font-bold"
                  style={{
                ...
                >
                  ...
                  <span>Your funds are always protected — 100% guaranteed</span>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div
            className={`text-center mb-7 md:mb-10 ${paymentsOn ? "anim-up" : ""}`}
            style={{ opacity: paymentsOn ? 1 : 0 }}
          >
            ...
            <p className="text-sm" style={{ color: C.g500 }}>
              Over 100 payment methods across Africa, Asia, Europe and the
              Americas.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            ...
            ].map(({ cat, icon: Icon, color, items }, gi) => (
              <div
                key={cat}
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((p) => (
                    <span
                      key={p}
                      className="px-2.5 py-1.5 text-xs font-bold rounded-xl"
                      style={{
                        background: `${color}10`,
                        color,
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div
            className={`text-center mb-7 md:mb-10 ${countriesOn ? "anim-up" : ""}`}
            style={{ opacity: countriesOn ? 1 : 0 }}
          >
            ...
            <p className="text-sm max-w-lg mx-auto" style={{ color: C.g500 }}>
              180+ countries supported. Trade in your local currency with local
              payment methods — wherever you are.
            </p>
          </div>

          <div
            className={`grid grid-cols-3 sm:grid-cols-6 gap-2 sm:gap-4 mb-8 md:mb-10 ${countriesOn ? "anim-up" : ""}`}
          ...
          >
            {[
              ...
              <div
                key={name}
                className="card-up bg-white rounded-2xl p-3 border text-center"
                style={{ borderColor: C.g200 }}
              >
          ...
          >
            {[
              ...
              { icon: ShieldCheck, v: "99.8%", l: "Dispute Resolution" },
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div
            className={`text-center mb-8 md:mb-12 ${testimonialsOn ? "anim-up" : ""}`}
            style={{ opacity: testimonialsOn ? 1 : 0 }}
          >
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div
                    className="w-11 h-11 rounded-xl flex items-center justify-center font-black text-white flex-shrink-0 text-base"
        ...
        <div className="max-w-5xl mx-auto">
          {user ? (
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg,${C.forest} 0%,#0c2418 55%,${C.green} 100%)`,
                border: `2px solid ${C.gold}30`,
              }}
            >
              {/* dot grid */}
              <div
                className="absolute pointer-events-none inset-0 rounded-3xl"
                style={{
                  backgroundImage:
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      ...
                      <strong style={{ color: "#FDE68A" }}>
                        0.1–0.3% BTC commission
                      </strong>{" "}
                      on every trade your referrals complete. No cap, no expiry.
                    </p>
                  ...
                  <div className="flex-shrink-0 w-full md:w-56">
                    ...
                    >
                      ...
                      >
                        Your friends earn $2 in free Bitcoin when they join via
                        your link.
                      </p>
                      <div className="space-y-1.5">
                        {[
                          {
                            dot: C.gold,
                            text: "They register → $1 BTC locked",
                          },
                          {
                            dot: C.mint,
                            text: "They verify  → $1 stays locked",
                          },
                          {
                            dot: C.online,
                            text: "First trade   → $2 unlocked!",
                          },
                        ].map(({ dot, text }) => (
                          <div
                            key={text}
              ...
              <div className="p-6 md:p-10">
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    >
                      Earn <span className="grad-text">$2 in Bitcoin</span>
                      <br />
                      Just for Joining PRAQEN
                    </h2>
                    <p
                      className="text-sm mb-6 max-w-md mx-auto md:mx-0"
                      style={{ color: "rgba(255,255,255,.65)" }}
                    >
                      New accounts get $1 BTC locked on sign-up. Verify your
                      account, complete your first trade — and the full $2
                      unlocks instantly to your wallet.
                    </p>
                    <button
                      onClick={() => goTo("/register")}
                  ...
                  <div className="flex-shrink-0 w-full md:w-64 space-y-3">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "$2 BTC unlocks to your wallet",
                      },
                      ...
                      >
                        ...
                        <span
                          className="ml-auto text-xs font-black px-2 py-0.5 rounded-full flex-shrink-0"
      ...
      <section
        ...
        style={{
          background: `linear-gradient(140deg,${C.forest},#0c2418,${C.green})`,
        }}
      >
        <div
          className="absolute inset-0 pointer-events-none"
        ...
        />
        <div
          className="absolute right-0 top-0 rounded-full blur-3xl pointer-events-none"
          style={{
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "'Syne',sans-serif" }}
          >
            {user ? "Keep Trading. Keep Growing." : "Join 2.4M+ Traders Today."}
            <br />
              ...
              <>
                <button
                  ...
                  style={{
                    background: C.gold,
                    color: C.forest,
                    boxShadow: `0 4px 22px ${C.gold}45`,
                  }}
                >
                  <Bitcoin size={18} /> Buy Bitcoin Now <ArrowRight size={16} />
                </button>
                <button
                  onClick={() => goTo("/create-offer")}
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-black text-base hover:bg-white/20 active:scale-95 transition"
                  style={{
                    background: "rgba(255,255,255,.1)",
                    color: "#fff",
          ...
          <div
            className="flex flex-wrap justify-center gap-6 pt-6 border-t"
            style={{ borderColor: "rgba(255,255,255,.1)" }}
          >
            {[
      ...
      <section className="py-10 md:py-20 px-4" style={{ background: C.g50 }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              {
                q: "Is PRAQEN safe to use?",
                a: "Absolutely. Every trade uses our escrow system — Bitcoin is locked before any money changes hands. Our dispute team resolves any issue within 24 hours. Your funds are always 100% protected.",
              },
              {
                q: "How does escrow work?",
                a: "When a trade starts, the seller's Bitcoin is automatically locked in our escrow. You send your payment. Once the seller confirms receipt, BTC is instantly released to your wallet. Neither party can touch the funds during the trade.",
              },
              {
                q: "What are the fees?",
                a: "We charge a flat 0.5% fee on completed trades only. No listing fees, no withdrawal fees, no monthly subscriptions. You pay absolutely nothing until a trade succeeds.",
              },
              {
                q: "How long does a trade take?",
                a: "Mobile money trades (MTN, M-Pesa, OPay) typically complete in 5–15 minutes. Bank transfers take 15–30 minutes. We average under 8 minutes across all payment methods.",
              },
              {
                q: "What happens if there is a dispute?",
                a: "Open a dispute inside the trade chat with evidence. Our neutral support team reviews both sides and resolves it quickly — your Bitcoin stays locked safe in escrow throughout the entire process.",
              },
              {
                q: "Which countries are supported?",
                a: "180+ countries worldwide. We have deep local payment support in Africa (Ghana, Nigeria, Kenya, South Africa), Asia (China, India, Japan, UAE), Europe (Germany, UK, France) and the Americas (USA, Canada, Brazil) — with more regions added regularly.",
              },
              {
                q: "Can I create my own trading offers?",
                a: "Yes! As a verified trader you can post your own offers with your preferred rate, payment method, trade limits and terms. Your offer, your rules. Thousands of traders will see it instantly.",
              },
            ].map(({ q, a }, i) => (
              <div
                key={i}
      ...
      <footer style={{ background: C.forest }}>
        <div className="max-w-3xl mx-auto px-4 py-10 text-center">
          ...
          <p
            ...
            style={{ color: "rgba(255,255,255,.45)" }}
          >
            The world's most trusted P2P Bitcoin &amp; USDT platform ·
            Escrow-protected · 0.5% flat fee
          </p>
          ...
          >
            ...
            <p className="text-xs" style={{ color: "rgba(255,255,255,.25)" }}>
              © {new Date().getFullYear()} PRAQEN · All rights reserved · Not
              financial advice
            </p>
          </div>
        </div>
